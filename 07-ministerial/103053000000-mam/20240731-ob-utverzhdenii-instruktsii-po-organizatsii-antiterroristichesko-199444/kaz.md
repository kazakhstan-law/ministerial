---
version_id: '199444_749964'
act_code: '199444'
language: kaz
title: Мәдениет саласындағы қызметтерді жүзеге асыратын террористік тұрғыдан осал объектілерді терроризмге қарсы қорғауды ұйымдастыру жөніндегі нұсқаулықты бекіту туралы
requisite: Қазақстан Республикасы Мәдениет және ақпарат министрінің 2024 жылғы 31 шілдедегі № 334-НҚ бұйрығы. Қазақстан Республикасының Әділет министрлігінде 2024 жылғы 1 тамызда № 34875 болып тіркелді
form: ПРИК
type_codes:
- ИНСТ
- ПРИК
...
source: https://zan.gov.kz/client/#!/doc/199444/kaz
---
