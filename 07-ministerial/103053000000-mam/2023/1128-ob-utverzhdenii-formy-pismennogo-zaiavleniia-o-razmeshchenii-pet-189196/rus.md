...
(фамилия, имя, отчество (при его наличии), прошу разместить на интернет –
ресурсе петицию следующего содержания:
«__________________________________________________________________»
(с доводами и предложениями по предмету петиции), которая подается в адрес
_______________________________ (наименование государственного органа,
местного представительного и (или) исполнительного органа).
```
...
2) копия документа, подтверждающего соответствующее полномочия представителя (если петиция подается представителем заявителя);
