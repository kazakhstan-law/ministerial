...
caused_by:
  code: '29564'
  title: '"Жұмыс берушінің қаражаты есебінен қызметкерлерге сүт, емдеу-профилактикалық тағамдар рационын беру нормасын бекіту туралы" Қазақстан Республикасының Еңбек және халықты әлеуметтік қорғау министрінің 2005 жылғы 29 маусымдағы № 170-ө бұйрығына толықтыру енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/29564/kaz
