...
4) заңды тұлғаның мемлекеттік тіркелгенін (қайта тіркелгенін) растайтын «электрондық үкіметтің» ақпараттық жүйесінен мәліметтер не заңды тұлғаның құқық қабілеттілігін растайтын өзге де құжат (шетел азаматтары үшін);
