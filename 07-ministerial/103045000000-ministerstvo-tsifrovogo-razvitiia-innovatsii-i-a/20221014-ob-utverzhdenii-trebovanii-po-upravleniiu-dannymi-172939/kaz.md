...
caused_by:
  code: '193675'
  title: Қазақстан Республикасы Цифрлық даму, инновациялар және аэроғарыш өнеркәсібі министрінің 2022 жылғы 14 қазандағы № 385/НҚ «Деректерді басқару жөніндегі талаптарды бекіту туралы» бұйрығына өзгерістер мен толықтыру енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/193675/kaz
source: https://zan.gov.kz/client/#!/doc/172939/kaz/23.02.2024
---
