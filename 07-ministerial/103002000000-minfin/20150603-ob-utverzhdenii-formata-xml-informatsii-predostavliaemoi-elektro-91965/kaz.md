---
version_id: '91965_35307'
act_code: '91965'
language: kaz
title: Қаржы мониторингі субъектілерінің электрондық тәсілмен берілетін ақпараттың ХМL пішімін бекіту туралы
requisite: Қазақстан Республикасы Қаржы министрінің 2015 жылғы 3 маусымдағы № 345 бұйрығы. Қазақстан Республикасының Әділет министрлігінде 2015 жылы 7 шілдеде № 11569 болып тіркелді. Күші жойылды - Қазақстан Республикасы Қаржы министрінің 2020 жылғы 24 қыркүйектегі № 915 (2020 жылдың 15 қарашасынан бастап қолданысқа енгізіледі) бұйрығымен
form: ПРИК
type_codes:
- ПРИК
approved_by:
