...
1. Утвердить прилагаемые:
   ...
   104) исключен приказом Министра финансов РК от 14.04.2017 № 250 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования);

   105) исключен приказом Министра финансов РК от 14.04.2017 № 250 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования);
   ...
   125) правила составления налоговой отчетности (декларации) по индивидуальному подоходному налогу и социальному налогу (форма 200.00) согласно приложению 125 к настоящему приказу.
        ...
        > *Сноска. Пункт 1 в редакции приказа Министра финансов РК от 31.10.2016 № 579 (порядок введения в действие см. п.3); с изменениями, внесенными приказом Министра финансов РК от 14.04.2017 № 250 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования); от 31.10.2016 № 579 (вводится в действие с 01.07.2017).*
...
| [`sec017`](rus/sec017.md) | 17. Раздел "Численность и расходы по оплате труда работников-инвалидов" заполняется специализированными организациями, в которых работают инвалиды с нарушениями опорно-двигательного аппарата, по потере слуха, речи, зрения, соответствующими условиям пункта 3 статьи 135 НК. |
| [`sec017_009`](rus/sec017_009.md) | 17. Раздел "Исчисление индивидуального подоходного налога с доходов трудового иммигранта": |
...
| [`sec001`](rus/sec001.md) | Раздел 1 заполняется Покупателем товаров, а также комиссионером, поверенным, в случаях, установленных нормами статьи 276-19 Налогового кодекса Республики Казахстан. |
| [`sec021`](rus/sec021.md) | 21. Раздел "Сумма акциза по виноматериалу": |
...
| [`sec020`](rus/sec020.md) | 20. Раздел "Численность и расходы по оплате труда работников-инвалидов" заполняется специализированными организациями, в которых работают инвалиды с нарушениями опорно-двигательного аппарата, по потере слуха, речи, зрения, соответствующими условиям пункта 3 статьи 135 Налогового кодекса. В данном разделе: |
| [`sec023`](rus/sec023.md) | 23. Раздел "Сумма НДС, относимого в зачет и использованного для целей оборота, облагаемого по нулевой ставке" не заполняется плательщиками налога на добавленную стоимость, у которых выполняются условия предусмотренные пунктом 2 статьи 25 Закона о введении и пунктом 3 статьи 272 Налогового кодекса. |
| [`sec022_034`](rus/sec022_034.md) | 22. Раздел "Сумма НДС, относимого в зачет и использованного для целей оборота, облагаемого по нулевой ставке" не заполняется плательщиками налога на добавленную стоимость, у которых выполняются условия предусмотренные пунктом 2 статьи 25 Закона о введении и пунктом 3 статьи 272 Налогового кодекса. |
| [`sec030_035`](rus/sec030_035.md) | 30. Раздел "Импорт алкогольной продукции, не подлежащий обложению акцизом": |
| [`sec027`](rus/sec027.md) | 27. Раздел "Сведения об объемах водопользования для исчисления платы" заполняется в единицах измерения водопользования, указанных в строке 6: |
| [`sec046`](rus/sec046.md) | 46. Раздел "Расходы на обучение казахстанских кадров и развитие социальной сферы", заполняется недропользователем в соответствии с условиями контракта на недропользование и нормами законодательства. |
| [`sec017_039`](rus/sec017_039.md) | 17. Раздел "Исчисление индивидуального подоходного налога с доходов трудового иммигранта": |
| [`sec022_043`](rus/sec022_043.md) | 22. Раздел "Сумма НДС, относимого в зачет и использованного для целей оборота, облагаемого по нулевой ставке" не заполняется плательщиками налога на добавленную стоимость, у которых выполняются условия предусмотренные пунктом 2 статьи 25 Закона о введении и пунктом 3 статьи 272 Налогового кодекса. |
| [`sec030_044`](rus/sec030_044.md) | 30. Раздел "Импорт алкогольной продукции, не подлежащий обложению акцизом": |
| [`sec026_046`](rus/sec026_046.md) | 26. Раздел "Сведения об объемах водопользования для исчисления платы" заполняется в единицах измерения водопользования, указанных в строке 6: |
| [`sec020_047`](rus/sec020_047.md) | 20. Раздел "Численность и расходы по оплате труда работников-инвалидов" заполняется специализированными организациями, в которых работают инвалиды с нарушениями опорно-двигательного аппарата, по потере слуха, речи, зрения, соответствующими условиям пункта 3 статьи 135 Налогового кодекса. |
| [`sec032`](rus/sec032.md) | 32. Раздел "Социальный налог за работников" предназначен для исчисления социального налога за работников, за исключением работников-иностранных специалистов и иностранных рабочих: |
