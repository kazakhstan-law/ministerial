...
requisite: Приказ и.о. Министра финансов Республики Казахстан от 5 января 2017 года № 6. Зарегистрирован в Министерстве юстиции Республики Казахстан 20 января 2017 года № 14705. Утратил силу приказом Министра финансов Республики Казахстан от 24 сентября 2020 года № 915 (вводится в действие с 15 ноября 2020 года)
form: ПРИК
type_codes:
- ПРИК
- ТРЕБ
...
registry_number: '109466'
source: https://zan.gov.kz/client/#!/doc/109466/rus/05.01.2017
---
...
5. Программа организации внутреннего контроля в целях ПОД/ФТ содержит:
   ...
   2) процедуру отказа клиентам в установлении деловых отношений, а также отказа в проведении операции с деньгами и (или) иным имуществом, в случае невозможности принятия мер, предусмотренных подпунктами 1), 2), 2-1), 4) и 6) пункта 3 статьи 5 Закона, и принятия мер по замораживанию операций с деньгами и (или) иным имуществом с направлением информации об отказе и принятых мерах по замораживанию по форме ФМ-1;

   3) процедуру признания сложной, необычно крупной и другой необычной операции, подлежащей изучению, в качестве подозрительной;

   4) процедуру представления сведений и информации об операциях, подлежащих финансовому мониторингу, о фактах отказа клиенту в установлении деловых отношений, прекращения деловых отношений с клиентом, отказа в проведении операции с деньгами и (или) иным имуществом, о мерах по замораживанию операций с деньгами и (или) иным имуществом в уполномоченный орган, включая указания и регламенты работы в автоматизированных информационных системах и программном обеспечении, используемых для передачи сведений, информации и документов в уполномоченный орган;

   5) процедуру фиксирования и хранения документов и сведений, полученных по результатам надлежащей проверки клиента, включая досье клиента и переписку с ним, документов и сведений об операциях, подлежащих финансовому мониторингу, в том числе, подозрительных операциях, а также результатов изучения всех сложных, необычно крупных и других необычных операций.
   ...
   6) процедуру информирования работниками первого руководителя о ставших им известными фактах нарушения законодательства о ПОД/ФТ, ПВК допущенных работниками субъекта;

6. ПВК предусматривают определение работника, либо структурного подразделения субъекта по соблюдению ПВК и реализации программ.
...
9. Программа управления риском ОД/ФТ, учитывающая риски клиентов и риски использования услуг в преступных целях, включая риск использования технологических достижений предусматривает проведение субъектом оценки риска совершения клиентом операций с деньгами и (или) иным имуществом, связанных с ОД/ФТ с присвоением степеней риска.
   ...
   Степени риска, присваиваемые клиенту, пересматриваются по мере необходимости, но не реже одного раза в год.
...
10. В программе управления риском высокая степень риска ОД/ФТ присваивается:
    ...
    3) операции с деньгами и (или) иным имуществом:
       ...
       по которой рыночная стоимость предмета совершаемой сделки крайне

       занижена по сравнению с рыночной стоимостью, чей размер устанавливается в целях ускоренного заключения операции по продаже предмета операции;
...
13. Программа мониторинга и изучения операций клиентов, включая изучение сложных, необычно крупных и других необычных операций клиентов, заключается в выявлении операций, указанных в пунктах 1, 2, 3 и 4 статьи 4 Закона.
...
15. Сведения и информация о выявленных в результате мониторинга операциях клиентов, указанных в пунктах 1, 2 и 3 статьи 4 Закона представляются субъектом в уполномоченный орган по форме ФМ-1.
