...
| [`an022`](kaz/an022.md) | «Қазақстан Республикасының салық заңнамасын түсіндіру» мемлекеттік көрсетілетін қызмет стандарты |
...
| [`an040`](kaz/an040.md) | «Кедендік баждардың, салықтардың және кедендік алымдардың артық (қате) төленген сомалары бар екендігі туралы растау»мемлекеттік көрсетілетін қызмет стандарты |
