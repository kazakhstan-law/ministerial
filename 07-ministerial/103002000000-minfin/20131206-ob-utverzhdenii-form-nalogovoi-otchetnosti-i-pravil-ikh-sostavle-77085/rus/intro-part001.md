...
15. В разделе «Совокупный годовой доход»:
    ...
    1) в строке 100.00.001 указывается сумма дохода от реализации, определяемая в соответствии со статьей 86 Налогового кодекса, а также суммы доходов страховой, перестраховочной организации в виде страховых премий по договорам страхования, перестрахования, заключенным с 1 января 2012 года;
...
16. В разделе «Вычеты»:
    ...
    4) в строке 100.00.012 указывается сумма вычета по начисленным социальным отчислениям в Государственный фонд социального страхования, относимая на вычеты в соответствии с пунктом 14-1
    ...
    12) в строке 100.00.020 указывается сумма прочих расходов, относимая на вычеты в соответствии с Налоговым кодексом. По данной строке отражаются следующие вычеты:
        ...
        страховые выплаты и комиссионные вознаграждения по договорам страхования, перестрахования, заключенным с 1 января 2012 года;
