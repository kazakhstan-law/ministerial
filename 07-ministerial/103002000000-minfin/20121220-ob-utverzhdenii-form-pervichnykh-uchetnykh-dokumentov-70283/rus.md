...
| [`part008`](rus/part008.md) | АКТ ПРИЕМКИ - ПЕРЕДАЧИ АКТИВА В МОНТАЖ |
| [`part013`](rus/part013.md) | ИНВЕНТАРИЗАЦИОННАЯ ОПИСЬ ЗАПАСОВ, ПРИНЯТЫХ (СДАННЫХ) НА ОТВЕТСТВЕННОЕ ХРАНЕНИЕ РАСПИСКА |
