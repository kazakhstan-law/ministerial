...
6. В настоящих Правилах, кроме понятий, используемых в Законе применяются следующие:
   ...
   5) IP-телефония - технология, позволяющая использовать IP-сеть для предоставления услуг телефонной связи и передачи факсимильных сообщений в режиме реального времени;
...
43. Доступ к узлам (маршрутизаторам) операторов сетей передачи данных, телематических служб, интеллектуальных сетей, поставщиков услуг связи может быть организован по различным схемам:
...
44. Пропуск исходящего телефонного трафика, создаваемого пользователями IP-сетей, осуществляется через коммутационное поле оператора СТОП.
