...
caused_by:
  code: '84654'
  title: О внесении изменений и дополнения в приказ Генерального Прокурора Республики Казахстан от 20 января 2012 года № 4 "Об утверждении Инструкции по организации работы с обращениями в органах, ведомствах и учреждениях прокуратуры Республики Казахстан"
  link: https://zan.gov.kz/client/#!/doc/84654/rus
source: https://zan.gov.kz/client/#!/doc/63512/rus/17.10.2014
---
...
Пункт 1 предусмотрен в редакции приказа Генерального Прокурора РК от 17.10.2014 № 122 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования, но не ранее 01.01.2015).
...
8. Заявления о реабилитации лиц, подвергшихся репрессиям, рассматриваются в порядке, предусмотренном Законом Республики Казахстан "О реабилитации жертв массовых политических репрессий".
   ...
   Инструкция дополнится пунктом 8-1 приказом Генерального Прокурора РК от 17.10.2014 № 122 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования, но не ранее 01.01.2015).
...
Пункт 17 предусмотрен в редакции приказа Генерального Прокурора РК от 17.10.2014 № 122 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования, но не ранее 01.01.2015).
...
Пункт 19 предусмотрен в редакции приказа Генерального Прокурора РК от 17.10.2014 № 122 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования, но не ранее 01.01.2015).
...
23. Управлением по надзору за применением законов о рассмотрении обращений и делопроизводства Генеральной прокуратуры рассматриваются:
    ...
    2) повторные обращения, поступившие от одного и того же лица по одному и тому же вопросу без приложения ответа прокурора области, приравненного к нему прокурора.
       ...
       Подпункт 3) пункта 23 предусмотрен в редакции приказа Генерального Прокурора РК от 17.10.2014 № 122 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования, но не ранее 01.01.2015).
...
30. При наличии в обращении вопросов, относящихся к компетенции нескольких подразделений прокуратуры, рассмотрение обращения поручается руководителям соответствующих структурных подразделений. Ответственным за подготовку сводного ответа заявителю является руководитель структурного подразделения, указанный в поручении первым.
    ...
    В пункт 31 предусмотрено изменение приказом Генерального Прокурора РК от 17.10.2014 № 122 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования, но не ранее 01.01.2015).
...
48. По результатам рассмотрения обращения может быть принято одно из следующих решений:
    ...
    В пункт 49 предусмотрено изменение приказом Генерального Прокурора РК от 17.10.2014 № 122 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования, но не ранее 01.01.2015).
