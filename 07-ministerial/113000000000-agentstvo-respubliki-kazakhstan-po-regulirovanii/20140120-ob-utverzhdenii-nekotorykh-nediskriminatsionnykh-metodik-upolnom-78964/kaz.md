...
caused_by:
  code: '117626'
  title: «Табиғи монополиялар салаларындағы және реттелетін нарықтардағы басшылықты жүзеге асыратын мемлекеттік органның бір қатар әдістемелерін бекіту туралы» Қазақстан Республикасы Табиғи монополияларды реттеу агенттігі төрағасының 2014 жылғы 20 қаңтардағы № 13-НҚ бұйрығына өзгерістер мен толықтыру енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/117626/kaz
