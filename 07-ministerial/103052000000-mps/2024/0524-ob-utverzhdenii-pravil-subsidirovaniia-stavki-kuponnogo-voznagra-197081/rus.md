...
Фамилия, имя, отчество (при его наличии) и подпись руководителя эмитента или лица, его замещающего __________________________________________________________

Дата подачи «___»_______ 20 __ года.

Примечание:

расшифровка аббревиатур: * БИН – бизнес-идентификационный номер; ** ISIN (НИН) – международный идентификационный номер (национальный идентификационный номер).
