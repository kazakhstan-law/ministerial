---
version_id: '156828_820595'
act_code: '156828'
language: rus
title: Об утверждении Правил оценки соответствия
requisite: Приказ и.о. Министра торговли и интеграции Республики Казахстан от 29 июня 2021 года № 433-НҚ. Зарегистрирован в Министерстве юстиции Республики Казахстан 8 июля 2021 года № 23364
form: ПРИК
type_codes:
- ПРИК
approved_by:
...
caused_by:
  code: '223381'
  title: О внесении изменений и дополнений в приказ исполняющего обязанности Министра торговли и интеграции Республики Казахстан от 29 июня 2021 года № 433-НҚ «Об утверждении Правил оценки соответствия»
  link: https://zan.gov.kz/client/#!/doc/223381/rus
source: https://zan.gov.kz/client/#!/doc/156828/rus
---
...
14. Для проведения сертификации продукции заявитель направляет в ОПС заявку, содержащую следующую информацию и документы и (или) их копии, заверенные подписью и печатью (при наличии) заявителя (в зависимости от схемы сертификации продукции):
    ...
    1) для продукции серийного производства:
       ...
       идентификационный код товара, присвоенный в Национальном каталоге товаров;
...
> *Сноска. Пункт 14 в редакции приказа и.о. Заместителя Премьер-Министра - Министра торговли и интеграции РК от 30.03.2023 № 124-НҚ (вводится в действие по истечении десяти календарных дня его первого официального опубликованию); с изменениями, внесенными приказами Министра торговли и интеграции РК от 15.09.2025 № 263-НҚ (вводится в действие по истечении шестидесяти календарных дней после дня его первого официального опубликования); и.о. Министра торговли и интеграции РК от 01.04.2026 № 155-НҚ (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования).*
...
71. Для регистрации декларации о соответствии, заявитель представляет в ОПС:
    ...
    1) заявку о регистрации декларации о соответствии в информационной системе технического регулирования, содержащую следующие сведения:
       ...
       код (коды) продукции в соответствии с ТНВЭД ЕАЭС и идентификационный код товара, присвоенный в Национальном каталоге товаров;
...
> *Сноска. Пункт 71 с изменениями, внесенными приказами и.о. Министра торговли и интеграции РК от 09.10.2024 № 350-НҚ (вводится в действие по истечении шестидесяти календарных дней после дня его первого официального опубликования); от 01.04.2026 № 155-НҚ (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования).*
...
85. Испытания проводятся в сроки, предусмотренные техническими регламентами и (или) документами по стандартизации, на методы испытаний данного объекта и согласованные с ОПС.
    ...
    Продолжительность проведения работ по оценке соответствия единичных транспортных средств, а также объем временных затрат на проведение необходимых испытаний (исследований) и экспертизы определяются в соответствии с национальным стандартом СТ РК 4038-2026 «Единичные транспортные средства. Нормы времени на проведение работ по оценке соответствия единичных транспортных средств.

> *Сноска. Пункт 85 с изменением, внесенным приказом и.о. Министра торговли и интеграции РК от 01.04.2026 № 155-НҚ (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования).*
...
руководителя__________________________________________________________
          ...
          7. Код (коды) продукции в соответствии с ТНВЭД ЕАЭС и идентификационный код товара, присвоенный в Национальном каталоге товаров
...
> *Сноска. Приложение 3 в редакции приказов и.о. Министра торговли и интеграции РК от 09.10.2024 № 350-НҚ (вводится в действие по истечении шестидесяти календарных дней после дня его первого официального опубликования); и.о. Министра торговли и интеграции РК от 01.04.2026 № 155-НҚ (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования).*

> *Форма*

## Акт отбора образцов

от «___» ___________ 20__ года по заявке № __ от «__» ______ 20__ года

Предприятие____________________________________________________ (бизнес-идентификационный номер (БИН)/ индивидуальный идентификационный номер (ИИН) и наименование, адрес)

Адрес и место отбора____________________________________________
...
С участием заказчика или его представителя _________________________
...
Образцы предъявленной продукции для сертификационных испытаний отобраны в соответствии с

________________________________________

(наименование документа по стандартизации)

Продукция получена по ___________________________________________
...
индивидуальный идентификационный номер (ИИН), наименование, страна, адрес)
...
Осмотром установлено ___________________________________________

Условия хранения _______________________________________________

Вид и состояние тары, упаковки, емкостей ___________________________

Надписи на упаковке и этикетках ___________________________________
...
<td>Код Единой Товарной номенклатуры внешнеэкономической деятельности Евразийского экономического союза</td>
<td>Идентификационный код товара, присвоенный в Национальном каталоге товаров</td>
</tr>
<tr>
<td>1</td>
<td>2</td>
