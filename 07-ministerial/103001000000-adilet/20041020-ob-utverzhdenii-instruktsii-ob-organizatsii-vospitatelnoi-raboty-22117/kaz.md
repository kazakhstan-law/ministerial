...
caused_by:
  code: '48430'
  title: '"Қазақстан Республикасы Әділет министрлігі түзеу мекемелерiндегi сотталғандармен тәрбие жұмысын ұйымдастыру жөнiндегi нұсқаулықты бекіту туралы" Қазақстан Республикасы Әділет министрінің 2004 жылғы 21 қазандағы N 305 бұйрығына өзгерістер мен толықтыру енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/48430/kaz
