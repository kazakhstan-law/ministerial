...
caused_by:
  code: '171137'
  title: О внесении изменений и дополнения в приказ Министра юстиции Республики Казахстан от 29 августа 2018 года № 1349 «Об утверждении Правил проведения экспертизы заявок на селекционные достижения, объекты промышленной собственности, товарные знаки и наименования мест происхождения товаров, регистрацию топологий интегральных микросхем»
  link: https://zan.gov.kz/client/#!/doc/171137/rus
