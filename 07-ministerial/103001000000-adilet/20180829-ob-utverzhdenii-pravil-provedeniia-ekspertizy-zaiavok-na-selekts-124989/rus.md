...
caused_by:
  code: '197882'
  title: О внесении изменений в приказ Министра юстиции Республики Казахстан от 29 августа 2018 года № 1349 «Об утверждении Правил проведения экспертизы заявок на селекционные достижения, объекты промышленной собственности, товарные знаки, знаки обслуживания, географические указания, наименования мест происхождения товаров, о регистрации топологий интегральных микросхем»
  link: https://zan.gov.kz/client/#!/doc/197882/rus
...
> *заявок на селекционные достижения*
...
<td colspan="3">(21) № регистрации</td>
...
ЗАЯВЛЕНИЕ
о выдаче патента
Республики Казахстан на селекционное достижение
(животноводство)
</pre>
</td>
<td colspan="4"></td>
...
<td>Код страны по стандарту 3 Всемирной организации интеллектуальной собственности (далее - ВОИС) (если он установлен)</td>
</tr>
<tr>
<td colspan="8">
<pre>
...
<tr>
<td colspan="7">Предлагаемое наименование</td>
<td></td>
</tr>
<tr>
<td colspan="8">
...
<pre>
В стране подачи заявки: □ - нет □ - да впервые ____под названием ___
                          (дата)
В других странах: □ - нет □ - да впервые __________________
                                          (страна, дата)
</pre>
...
<td colspan="4">(97) Полный почтовый адрес местожительства, включая наименование страны и ее код по стандарту 3 ВОИС, если он установлен</td>
<td colspan="2">Подпись (и) автора (ов) – заявителя (ей) и/или автора (ов), переуступившего (их) право на получение патента, дата</td>
</tr>
<tr>
<td colspan="8">
...
<td colspan="5">(21) № регистрации</td>
<td colspan="3">(22) Дата подачи</td>
<td>Приоритет</td>
</tr>
<tr>
...
<td colspan="2">Код страны подачи (ST.3 ВОИС)</td>
<td colspan="4">Стадия рассмотрения заявки</td>
...
<pre>
Род, вид __________________________________________________
          (название на государственном или русском языке)
...
<tr>
<td colspan="10">Предлагаемое наименование</td>
...
Предлагался ли сорт (порода) к продаже или продавался:
<pre>
В стране подачи заявки: □ - нет □ - да впервые ____ под названием ______
                          (дата)
В других странах: □ - нет □ - да впервые _______________________________
                                                (страна, дата)
</pre>
под названием _______________________________________________________________________
</td>
...
<tr>
<td colspan="5">□приложение к заявлению</td>
<td colspan="3"></td>
<td></td>
</tr>
<tr>
<td colspan="5">□анкета селекционного достижения</td>
<td colspan="3"></td>
<td></td>
</tr>
<tr>
<td colspan="5">□фотографии</td>
<td colspan="3"></td>
<td></td>
</tr>
<tr>
<td colspan="5">□негативы или цветные слайды</td>
<td colspan="3"></td>
<td></td>
</tr>
<tr>
<td colspan="5">□информация о ранее произведенной продаже</td>
<td colspan="3"></td>
<td></td>
</tr>
<tr>
<td colspan="5">□документ об оплате подачи заявки</td>
<td colspan="3"></td>
<td></td>
</tr>
<tr>
<td colspan="5">□документ, подтверждающий наличие оснований для уменьшения размера оплаты</td>
<td colspan="3"></td>
<td></td>
</tr>
<tr>
<td colspan="5">□копия первой заявки (при испрашивании конвенционного приоритета)</td>
<td colspan="3"></td>
<td></td>
</tr>
<tr>
<td colspan="5">□перевод заявки на государственный или русский язык</td>
<td colspan="3"></td>
<td></td>
</tr>
<tr>
<td colspan="5">□доверенность, удостоверяющая полномочия патентного поверенного или представителя</td>
<td colspan="3"></td>
<td></td>
</tr>
<tr>
<td colspan="5">□ другой документ (указать)</td>
<td colspan="3"></td>
<td></td>
</tr>
<tr>
...
<td colspan="6">(97) Полный почтовый адрес местожительства, включая наименование страны и ее код по стандарту 3 ВОИС, если он установлен</td>
</tr>
<tr>
</tr>
<tr>
...
> *Сноска. Пункт 88 с изменениями, внесенными приказами Министра юстиции РК от 26.12.2018 № 1630 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования); от 30.11.2020 № 677 (вводится в действие со дня его первого официального опубликования).*
...
> *Сноска. Пункт 3 с изменением, внесенным приказом Министра юстиции РК от 26.12.2018 № 1630 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования); в редакции приказа Министра юстиции РК от 08.02.2024 № 112 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования).*
...
16. Обозначения, указанные в пункте 1 статьи 6 Закона, используются как неохраняемые элементы товарного знака, если они не занимают в нем доминирующего положения. Указанные обозначения регистрируются в качестве товарного знака, если на дату подачи заявки обозначение в результате использования приобрело различительную способность.
    ...
    Обозначение или элемент (ы) обозначения считаются «едиными», если являются интегрированными, настолько объединёнными вместе, что не рассматриваются раздельно.
...
> *Сноска. Правый верхний угол приложения 2 в редакции приказа Министра юстиции РК от 31.08.2022 № 730 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования).*
