...
caused_by:
  code: '36053'
  title: '"Қазақстан Республикасының мемлекеттік заем және мемлекеттік кепілдіктер жөніндегі заңдық баға (legal оріnіоn) беру ережесін бекіту туралы" Қазақстан Республикасы Әділет министрінің 2002 жылғы 16 мамырдағы N 68 бұйрығына өзгерістер енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/36053/kaz
