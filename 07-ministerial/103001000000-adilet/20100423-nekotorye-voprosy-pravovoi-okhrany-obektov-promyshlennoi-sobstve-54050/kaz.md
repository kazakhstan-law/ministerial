...
caused_by:
  code: '65178'
  title: Өнеркәсіптік меншік объектілеріне басқаға беру шартын және өнеркәсіптік меншік объектілерін пайдалануға лицензиялық немесе сублицензиялық шарттарды тіркеу туралы өтініштер нысандарын бекіту және "Өнеркәсіптік меншік объектілерін құқықтық қорғаудың кейбір мәселелері" Қазақстан Республикасы Әділет министрінің м.а. 2010 жылғы 23 сәуірдегі № 136 бұйрығына өзгерістер енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/65178/kaz
