...
caused_by:
  code: '197652'
  title: «Нормативтік құқықтық актілерді әзірлеу, келісу және мемлекеттік тіркеу қағидаларын бекіту туралы» Қазақстан Республикасы Әділет министрінің міндетін атқарушының 2023 жылғы 5 шiлдедегi № 464 бұйрығына толықтырулар енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/197652/kaz
source: https://zan.gov.kz/client/#!/doc/183768/kaz/14.06.2024
---
