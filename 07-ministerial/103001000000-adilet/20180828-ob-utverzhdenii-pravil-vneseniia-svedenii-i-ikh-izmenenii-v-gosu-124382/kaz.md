...
caused_by:
  code: '140675'
  title: «Авторлық құқықпен қорғалатын объектілерге құқықтардың мемлекеттік тізіліміне мәліметтерді және олардың өзгерістерін енгізу қағидаларын және оған мәліметтер мен олардың өзгерістерін енгізуді растайтын куәліктің нысанын бекіту туралы» Қазақстан Республикасы Әділет министрінің 2018 жылғы 28 тамыздағы № 1315 бұйрығына өзгерістер енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/140675/kaz
