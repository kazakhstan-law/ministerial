...
caused_by:
  code: '155720'
  title: «Нотариустардың нотариаттық іс-әрекет жасау ережесін бекіту туралы» Қазақстан Республикасы Әділет министрінің 2012 жылғы 31 қаңтардағы № 31 бұйрығына өзгерістер мен толықтырулар енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/155720/kaz
