...
# Правила присоединения и взаимодействия сетей телекоммуникаций

## 1. Общие положения

1. Настоящие Правила присоединения и взаимодействия сетей телекоммуникаций (далее - Правила) разработаны в соответствии с подпунктом 19-13) пункта 1 статьи 8 Закона Республики Казахстан от 5 июля 2004 года «О связи» (далее – Закон), определяют порядок присоединения и взаимодействия сетей телекоммуникаций.
...
11. Присоединяемый оператор направляет заявку в произвольной форме присоединяющему оператору о выдаче технических условий на присоединение (далее – заявка). К заявке прилагается:
    ...
    3) сертификаты соответствия на применяемое оборудование;
...
52. Между операторами связи и/или владельцами сетей, участвующими в едином технологическом процессе предоставления услуг присоединения и пропуска трафика, заключается договор, предусматривающий:
    ...
    10) обеспечение корректной трансляции сигнальных параметров в соответствии с общеканальной сигнализацией сетей ОКС 7 или протоколами SIP-T/SIP-I, в том числе номера вызывающего абонента в международном формате (номер абонента А) в случае его присутствия в исходных записях коммутационного оборудования оператора связи (детализированная запись звонка – Call Detail Record).
...
58. В целях взыскания имеющейся задолженности оператором связи допускается ограничение входящего междугородного и/или международного трафика до погашения такой задолженности. В иных случаях ограничение пропуска операторами связи любого вида входящего/транзитного трафика без соответствующего решения суда не допускается.
...
65. В случае пропуска несанкционированного трафика, включая трафик с подменой номера абонента (номера А) принимающий трафик оператор связи незамедлительно уведомляет оператора связи от которого данный трафик получен. Оператор связи, получивший уведомление о пропуске несанкционированного трафика с его сети, в течение 10 календарных дней должен выяснить причины и принять меры к устранению такого трафика.

    В случае не устранения пропуска несанкционированного трафика, оператор связи, принимающий на свою сеть подобный трафик, обращается в судебные органы.
