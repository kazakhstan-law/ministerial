...
caused_by:
  code: '200406'
  title: «Трафикті өткізуді қоса алғанда, телекоммуникация желілерінің қосылу және өзара іс-қимыл жасау қағидалары және өзара есеп айырысу тәртібін бекіту туралы» Қазақстан Республикасы Инвестициялар және даму министрінің міндетін атқарушының 2016 жылғы 28 қаңтардағы № 119 бұйрығына өзгерістер енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/200406/kaz
...
2. Заңда пайдаланылатын ұғымдардан басқа, осы Қағидаларда мынадай ұғымдар қолданылады:
   ...
   25) рұқсат етілмеген трафик – осы Қағидалармен белгіленген трафик

       өткізу талаптарын бұза отырып өткізілген және Қосылу және өзара әрекет жасау шартының талаптарымен көзделмеген трафик, соның ішінде шақырылатын абонент нөмірі ауыстырылған трафик;
...
> *Ескерту. 2-тармаққа өзгеріс енгізілді - ҚР Цифрлық даму, инновациялар және аэроғарыш өнеркәсібі министрінің 02.08.2024 № 465/НҚ (алғашқы ресми жарияланған күнінен кейін күнтізбелік он күн өткен соң қолданысқа енгізіледі) бұйрығымен.*
