...
> *Ескерту. 29-қосымша жаңа редакцияда - ҚР Инвестициялар және даму министрінің 30.06.2017 № 415 (алғашқы ресми жарияланған күнінен кейін күнтізбелік он күн өткен соң қолданысқа енгізіледі) бұйрығымен.*

> *ГУ-27-У-ВЦ нысаны*

## Жүктерді тасымалдауға арналған ГУ-27-У-ВЦ нысанындағы жүк құжаты
...
```
Жөнелту станциясы          Код        Межелі станциясы            Код
Жөнелтуші                         Код         Алушы                  Код
Жөнелтуші: ОКПО                            Алушы: ОКПО
оның мекенжайы                                       оның мекенжайы
Төлемші                          Код
Банкілік деректемелер:
орталықтандырылған шоттар № туралы банк анықтамасы________________
```

## ЖҮК ТУРАЛЫ МӘЛІМЕТТЕР

```
Белгілер және маркалар       Атауы      Орындар саны                  Жүк
массасы, кг
Жүк           жөнелтуші                     Орама  (пакет/орын)
анықт._____________________________________
______________________________________________________________________
```
...
Жүкті тасымалдауға қабылдау  Т.Ж. жүкті түсіру. Жүкті беруге немесе алушының
құралдарымен түсіруге беруге ресімдеу
ТАСЫМАЛДАУШЫ БЕЛГІЛЕРІ
ЖҮКТІ БЕРУ ТУРАЛЫ БЕЛГІЛЕР ____________________________________________________
```
...
Жүк құжатқа енгізілген мәліметтердің дұрыстығына жауап беремін.
...
```
ЕРЕКШЕ БЕЛГІЛЕР:
№ жоспары бойынша тиеу тағайындалған. Бұрыштама нөмірі
Станция бастығы
...
белгілері және  атауы     Орама           анықт:
маркасы                  (бума/орын)
```

```
ҚОРЫТЫНДЫ МАССА:
Mасса анықталды:                                   массаны анықтау тәсілі:
Тиеу құралдарымен:                        Т. ж. қабылдап-тапсырушысы: ____

Жүк құжатқа енгізілген мәліметтердің дұрыстығына жауап беремін. Жөнелтуші: _______
...
ТАСЫМАЛДАУ ТӨЛЕМІ, Т.
вагон түрі, №  Рол  Г/п  Ос ___ МАССА кг_____ Пр  Не  Об. Жөнелту кезінде, беру кезінде
...
```
Жүкті тасымалдауға           Т.ж. жүгін түсіру        Жүк беруді
қабылдау                     немесе алушының
                             құралдарымен ресімдеу
                             түсіруге беру
```
...
Масса анықталды: массаны анықтау тәсілі: Тиеу құралдарымен: Т. ж. қабылдап-тапсырушысы: ____
...
Жүк құжатқа енгізілген мәліметтердің дұрыстығына жауап беремін.
Жөнелтуші: _______
Жүк орналастырылған және бекітілген:
ТАРАУ:	  ПАРАГРАФ:		БӨЛІМ:
Жөнелтуші:         _______     Тасымалдаушыдан:                    _______
```
...
```
ВАГОН ТУРАЛЫ МӘЛІМЕТ: Секция
№
ТАСЫМАЛДАУ ТӨЛЕМІ, Т.
вагон түрі, №  Рол   Г/п    Ос ____    МАССА кг_______   Пр  Не  Об.
...
```
Жүкті тасымалдауға      Т.ж. жүгін түсіру немесе         Жүк беруді
қабылдау                алушының құралдарымен            ресімдеу
                        түсіруге беру
```

## ҰЛТТЫҚ ИНФРАҚҰРЫЛЫМ ОПЕРАТОРЫНЫҢ БЕЛГІЛЕРІ
...
№ жоспары бойынша тиеу тағайындалған. Бұрыштама нөмірі
Станция бастығы_____________________
____________________________ГУ-27-У-ВЦ (ГУ-27в бойынша есепке алу)
```
...
```
Жөнелтушінің               Жүктің         Орындар саны        Жүк массасы, кг
белгілері және             атауы          Орама (бума/орын)   анықт:
маркасы
```
...
*[Image: ВАГОН ТУРАЛЫ МӘЛІМЕТ: Секция №]*

```
ТАСЫМАЛДАУ ТӨЛЕМІ, Т.
вагон түрі, №  Рол   Г/п    Ос ____    МАССА кг_______   Пр  Не  Об.  Жөнелту
...
Кем алу______________т.                   Асып кету______________т.
 Төлемші____________________________________________________
(________________)
Есеп айырысу түрі_____________________  (___)
Төлемдер нысаны:________________
ТАУАР КАССИРІ_________________
Жүк тасымалдауға
қабылданды
Уақыт туралы күнтізбелік мөрқалыптар
