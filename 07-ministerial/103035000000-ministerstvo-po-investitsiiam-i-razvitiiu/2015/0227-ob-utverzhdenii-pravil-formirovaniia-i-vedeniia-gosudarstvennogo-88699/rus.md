...
4. Реестр ведется местными исполнительными органами области, города республиканского значения, столицы (далее – акиматы) по форме согласно приложению к настоящим Правилам.
...
5. Реестры ведутся на бумажном и электронном носителях. Все страницы реестра в бумажном виде пронумеровываются, прошнуровываются, на последней странице указывается количество листов и скрепляется печатью.
