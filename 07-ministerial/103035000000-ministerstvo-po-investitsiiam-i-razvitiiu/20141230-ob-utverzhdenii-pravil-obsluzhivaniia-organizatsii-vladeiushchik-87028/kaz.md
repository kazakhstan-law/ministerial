...
caused_by:
  code: '169878'
  title: «Қауіпті өндірістік объектілерді иеленетін және (немесе) пайдаланатын ұйымдарға өнеркәсіптік қауіпсіздік саласындағы кәсіби авариялық-құтқару қызметтерінің қызмет көрсету қағидаларын бекіту туралы» Қазақстан Республикасы Инвестициялар және даму министрінің 2014 жылғы 30 желтоқсандағы № 347 бұйрығына өзгерістер енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/169878/kaz
source: https://zan.gov.kz/client/#!/doc/87028/kaz/20.09.2022
---
