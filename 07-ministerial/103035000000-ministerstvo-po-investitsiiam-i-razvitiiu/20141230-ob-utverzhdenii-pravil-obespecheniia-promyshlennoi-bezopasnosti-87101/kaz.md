...
caused_by:
  code: '175856'
  title: «Теңізде мұнай операцияларын жүргізуді жүзеге асыратын қауіпті өндірістік объектілер үшін өнеркәсіптік қауіпсіздікті қамтамасыз ету қағидаларын бекіту туралы» Қазақстан Республикасы Инвестициялар және даму министрінің 2014 жылғы 30 желтоқсандағы № 356 бұйрығына өзгерістер енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/175856/kaz
