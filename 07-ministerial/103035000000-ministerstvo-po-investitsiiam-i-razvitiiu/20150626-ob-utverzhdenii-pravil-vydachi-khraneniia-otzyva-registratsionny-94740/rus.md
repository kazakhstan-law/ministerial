...
| [`an003`](rus/an003.md) | Правила выдачи, хранения, отзыва регистрационного свидетельства и подтверждения принадлежности и действительности открытого ключа электронной цифровой подписи национальным удостоверяющим центром Республики Казахстан |
| [`part024`](rus/part024.md) | 1. Структура регистрационного свидетельства Национального удостоверяющего центра Республики Казахстан (на алгоритме RSA) |
