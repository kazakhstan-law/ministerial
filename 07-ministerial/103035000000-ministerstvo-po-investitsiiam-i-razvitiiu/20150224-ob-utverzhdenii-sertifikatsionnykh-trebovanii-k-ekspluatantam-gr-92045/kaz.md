...
caused_by:
  code: '179034'
  title: «Азаматтық әуе кемелерін пайдаланушыларға қойылатын сертификаттық талаптарды бекіту туралы» Қазақстан Республикасы Инвестициялар және даму министрінің міндетін атқарушының 2015 жылғы 24 ақпандағы № 153 бұйрығына өзгерістер мен толықтырулар енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/179034/kaz
source: https://zan.gov.kz/client/#!/doc/92045/kaz
---
