...
| [`an002`](rus/an002.md) | Методика по расчету выбросов парниковых газов от котлов тепловых электростанций, теплоэлектроцентралей и котельных |
| [`an003`](rus/an003.md) | Коэффициенты выбросов из утилитарных источников |
| [`part006`](rus/part006.md) | Коэффициенты выбросов по видам деятельности для субъектов администрирования. |
| [`an004`](rus/an004.md) | Методика по расчету выбросов парниковых газов от производства чугуна, стали, агломератов и окатышей |
| [`an005`](rus/an005.md) | Коэффициенты выбросов СН4 по умолчанию для производства кокса, чугуна и стали |
| [`an006`](rus/an006.md) | Молярная масса химических веществ |
| [`an007`](rus/an007.md) | Технологические параметры для электролизеров с предварительно обожженным анодом |
| [`an008`](rus/an008.md) | Парниковые газы, учитываемые как выбросы, отличные от изменений в углеродных пулах |
| [`an009`](rus/an009.md) | Методика по расчету выбросов парниковых газов от производства химической промышленности |
| [`an010`](rus/an010.md) | Методика по расчету выбросов парниковых газов от установок от производства стекла, керамики и минеральных материалов |
