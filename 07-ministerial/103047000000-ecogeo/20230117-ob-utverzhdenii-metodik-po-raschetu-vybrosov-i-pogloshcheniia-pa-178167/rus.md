...
```
          ECO2, BF= [(ORE × CORE)+Σ(CARBF × CCAR,BF)+ Σ (FLBF× CFL,BF)+ Σ (OT× COT)
– (IOUT × CI,out) – (BFGout× CBFG,out) – (RBF× CR,BF)] × 44/12, 				  (4),
```
