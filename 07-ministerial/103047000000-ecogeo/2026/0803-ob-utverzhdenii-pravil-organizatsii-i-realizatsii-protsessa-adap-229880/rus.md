...
1. Утвердить Правила организации и реализации процесса адаптации к изменению климата согласно приложению к настоящему приказу.
...
6. Сбор информации о климате и воздействии климата осуществляется центральными и местными исполнительными органами столицы, областей, городов республиканского значения для проведения оценки уязвимости и планирования адаптации к изменению климата на этапе анализа документов Системы государственного планирования и/или иных документов планирования, определенных в качестве приоритетной для адаптации к изменению климата.

7. Собираемая центральными и местными исполнительными органами столицы, областей, городов республиканского значения, информация для проведения оценки уязвимости и планирования адаптации к изменению климата охватывает информацию о климате и воздействии климата.
...
9. Сбор информации из доступных источников осуществляется центральными и местными исполнительными органами столицы, областей, городов республиканского значения с учетом специфики процесса планирования адаптации, адаптируемой сферы государственного управления (сельское хозяйство, водное хозяйство, лесное хозяйство, гражданская защита), и уровня планирования адаптации, специфики региона, по которому планируется адаптация.

10. Уполномоченный орган по запросам центральных и местных исполнительных органов столицы, областей, городов республиканского значения оказывает содействие центральным и местным исполнительным органам столицы, областей, городов республиканского значения в получении информации, указанной в пункте 8 настоящих Правил, от подведомственных организаций уполномоченного органа и из международных источников.

11. Информация о климате и воздействии климата, предусмотренная в подпункте 1) пункта 2 настоящих Правил, определяется уполномоченным органом по согласованию с центральными и местными исполнительными органами столицы, областей, городов республиканского значения, проводящими оценку уязвимости и планирование адаптации к изменению климата.

12. Собранная информация о климате и его воздействиях используется центральными и местными исполнительными органами столицы, областей, городов республиканского значения для оценки уязвимости, проводимой на этапе анализа и до начала этапа планирования разработки документов Системы государственного планирования и/или иных документов планирования, определенных в качестве приоритетной для адаптации к изменению климата.
...
14. Определение рамок воздействия осуществляется центральными и местными исполнительными органами столицы, областей, городов республиканского значения, проводящими оценку уязвимости к изменению климата.
...
15. При определении рамок воздействия центральные и местные исполнительные органы столицы, областей, городов республиканского значения:
...
16. В рамках одной оценки центральные и местные исполнительные органы столицы, областей, городов республиканского значения охватывают уязвимость к изменению климата приоритетной для адаптации сферы государственного управления.

17. Центральные и местные исполнительные органы столицы, областей, городов республиканского значения в месячный срок после завершения оценки уязвимости к изменению климата предоставляют уполномоченному органу информацию о результатах проведенной оценки уязвимости к изменению климата. Результаты оценки уязвимости к изменению климата оформляются в свободной форме.
...
20. Цели адаптации к изменению климата направлены на учет воздействий изменения климата на достижение целей документов Системы государственного планирования и/или иных документов планирования, определенных в качестве приоритетных для адаптации к изменению климата и возможности их корректировки с учетом выявленных уязвимостей к изменению климата.
...
22. Центральные и местные исполнительные органы столицы, областей, городов республиканского значения разрабатывают меры по адаптации к изменению климата на этапе разработки планов мероприятий к документам Системы государственного планирования и/или иным документам планирования, определенным в качестве приоритетных для адаптации к изменению климата.
...
23. Разработка мер по адаптации к изменению климата осуществляется центральными или местными исполнительными органами столицы, областей, городов республиканского значения, осуществляющие процесс адаптации к изменению климата, с участием заинтересованных сторон, представляющих общественные организации, общественность, бизнес, научные и экспертные организации, с которыми проводятся фокус-группы по конкретным факторам уязвимости или иным темам, относящимся к разрабатываемым мерам.
...
26. Объем мер по адаптации к изменению климата определяется центральными и местными исполнительными органами столицы, областей, городов республиканского значения на основе ранжированных уязвимостей и климатических опасностей и возможностей получения от их реализации положительных результатов вне зависимости от уровня климатических изменений.
...
27. Разработанные меры по адаптации к изменению климата оцениваются на основе следующих критериев:
    ...
    5) сроки реализации (в период действия документов Системы государственного планирования и/или иных документов планирования, долгосрочные, краткосрочные).
...
29. Приоритетность предлагаемых мер по адаптации к изменению климата определяется центральными и местными исполнительными органами столицы, областей, городов республиканского значения, осуществляющими процесс адаптации к изменению климата, по следующим уровням:
...
32. Меры по адаптации к изменению климата, получающие приоритет «внедрить», рассматриваются соответствующим центральным или местным исполнительным органом столицы, областей, городов республиканского значения на последующих этапах процесса адаптации к изменению климата. Меры, получившие оценку приоритета «оценить», требуют дальнейшего анализа для оценки возможности их реализации.
...
34. Центральные и местные исполнительные органы столицы, областей, городов республиканского значения реализуют процесс адаптации к изменению климата на основе интегрирования мер по адаптации к изменению климата в документы Системы государственного планирования и/или иные документы планирования, определенные в качестве приоритетных для адаптации к изменению климата, программы развития столицы, областей, городов республиканского значения.

    В первоочередном порядке интегрируются меры по адаптации к изменению климата, получившие оценку «Внедрить». Меры по адаптации к изменению климата, получившие оценку «Оценить» будут рассматриваться для включения в документы Системы государственного планирования и/или иные документы планирования по сферам государственного управления, являющиеся приоритетными для адаптации к изменению климата и программы развития территорий столицы, областей, городов республиканского значения, разрабатываемые на последующие периоды.

35. В соответствии с пунктом 2 статьи 313 Кодекса в случае приоритетных для адаптации к изменению климата сфер государственного управления (сельское хозяйство, водное хозяйство, лесное хозяйство, гражданская защита) цели и меры по адаптации к изменению климата уполномоченные государственные органы по данным сферам государственного управления рассматривают на этапе разработки документов Системы государственного планирования и/или иных документов планирования или внесения корректировок в действующие документы Системы государственного планирования и/или иные документы планирования.

36. На местном уровне согласно пункту 3 статьи 313 Кодекса при планировании адаптации к изменению климата местные исполнительные органы столицы, областей, городов республиканского значения рассматривают разработанные цели и меры по адаптации к изменению климата для включения в разделы по экологическим аспектам соответствующих программ развития территорий.

37. В случае действующих документов Системы государственного планирования и/или иных документов планирования, предусматривающих адаптацию к изменению климата, их корректировка производится государственным органом-разработчиком на основе предложений центральных и местных исполнительных органов столицы, областей, городов республиканского значения.
...
39. Уполномоченный орган осуществляет координацию деятельности с другими центральными и местными исполнительными органами столицы, областей, городов республиканского значения по организации и реализации процесса адаптации к изменению климата.
...
40. Центральные и местные исполнительные органы столицы, областей, городов республиканского значения предоставляют по запросу уполномоченного органа следующую информацию:

    1) результаты проведенных оценок уязвимости к изменению климата;

    2) разработанные меры по адаптации к изменению климата;

    3) меры по адаптации к изменению климата, интегрированные в документы Системы государственного планирования и/или иные документы планирования либо программы развития столицы, областей, городов республиканского значения с указанием ожидаемых результатов, сроков реализации, объемов и источников финансирования, ответственных исполнителей;
