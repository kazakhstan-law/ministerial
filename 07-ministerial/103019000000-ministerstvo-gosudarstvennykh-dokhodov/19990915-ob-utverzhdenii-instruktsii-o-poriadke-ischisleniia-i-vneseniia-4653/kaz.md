...
act_code: '4653'
language: kaz
title: '"Бюджетке бiртұтас жер салығын есептеу және енгізу тәртібі туралы" Нұсқауды бекiту туралы'
requisite: Бұйрық Қазақстан Республикасы Мемлекеттік кіріс министрлігі 1999 жылғы 16 қыркүйек N 1138. Қазақстан Республикасы Әділет министрлігінде 1999 жылғы 12 қазанда тіркелді. Тіркеу N 968. Күші жойылды - ҚР Мемлекеттік кіріс министрінің 2002 жылғы 9 сәуірдегі N 416 бұйрығымен.
form: ПРИК
type_codes:
- ИНСТ
- ПРИК
...
caused_by:
  code: '9813'
  title: '"Бірыңғай жер салығын бюджетке есептеу мен енгізу тәртібі туралы" Нұсқаулықты бекіту туралы 1999 жылғы 16 қыркүйектегі N 1138 Мемлекеттік кіріс министрінің Бұйрығына өзгерістер мен толықтырулар енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/9813/kaz
