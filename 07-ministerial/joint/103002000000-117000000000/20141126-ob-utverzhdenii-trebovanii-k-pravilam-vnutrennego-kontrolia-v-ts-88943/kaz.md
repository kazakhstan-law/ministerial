...
caused_by:
  code: '99427'
  title: Қазақстан Республикасы Қаржы Министрінің кейбір бұйрықтарына және Қазақстан Республикасы Ұлттық Банкі Басқармасының кейбір қаулыларына өзгерістер мен толықтырулар енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/99427/kaz
