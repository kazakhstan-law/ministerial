...
30. В соответствии со статьей 149 Кодекса Перевозчик выступает в качестве декларанта таможенной процедуры таможенного транзита.
...
37. При выпуске товаров в соответствии с таможенной процедурой таможенного транзита таможенный орган отправления устанавливает срок таможенного транзита и определяет место доставки товаров в соответствии с таможенным законодательством ЕАЭС и Республики Казахстан.
...
51. Для завершения таможенной процедуры таможенного транзита Перевозчик уведомляет о доставке товаров либо части товаров и транспортных средств таможенный орган назначения путем представления описи или транзитной декларации, а также имеющихся у него других документов в отношении товаров (транзитную декларацию, транспортные (перевозочные), сопроводительные (коммерческие) документы), акты общей формы (коммерческие акты) на несоответствие пломб или количества груза, составленные в пути следования, в течение времени, установленного технологическим процессом работы станции, но не позднее времени окончания следующего рабочего дня таможенного органа назначения с момента прибытия товара в место доставки.

    В описи должностное лицо таможенного органа назначения проставляет подпись и оттиск личной номерной печати, опись остается в таможенном органе назначения.

    По требованию таможенного органа назначения Перевозчик предъявляет товары.

52. В случае отсутствия ОГД на станции назначения, лицо, заключившее с Перевозчиком договор, в соответствии с которым оно может совершать таможенные операции, связанные с завершением таможенной процедуры таможенного транзита, для завершения таможенной процедуры таможенного транзита может представить транзитную декларацию, а также перевозочные (транспортные), сопроводительные (коммерческие) документы в ОГД в зоне деятельности которого находится данная станция.

    Таможенный орган назначения завершает таможенную процедуру таможенного транзита в короткие сроки, но не позднее сроков, установленных таможенным законодательством Республики Казахстан, после регистрации документов путем проставления штампа «Товар поступил», заверенного подписью и оттиском личной номерной печати должностного лица ОГД на транзитной декларации, а также на лицевой стороне первого листа железнодорожной накладной СМГС, ЦИМ/СМГС (оригинал накладной), второго листа дорожной ведомости.

53. После завершения таможенной процедуры таможенного транзита товаров Перевозчик или иное уполномоченное лицо не позднее времени окончания следующего рабочего дня таможенного органа назначения совершает таможенные операции, связанные с помещением товаров на временное хранение или их таможенным декларированием, в соответствии с таможенной процедурой.
...
54. При помещении Перевозчиком или иным уполномоченным лицом товаров на временное хранение, товары распределяются перевозчиком для помещения их в места временного хранения, указанные в транспортных (перевозочных) документах.
...
56. Таможенный орган назначения производит регистрацию документов, подтверждающих помещение товаров на временное хранение, в соответствии с таможенным законодательством ЕАЭС и Республики Казахстан, в срок не более одного часа после подачи таких документов.

    Подтверждением помещения товаров и транспортных средств на временное хранение является проставление на свободном месте первых листов представленных документов штампа «Товар помещен на временное хранение», содержащего сведения о регистрации номере, месте временного хранения, дате и времени регистрации, дате окончания срока временного хранения, которые заверяются подписью и оттиском личной номерной печати должностного лица ОГД.
