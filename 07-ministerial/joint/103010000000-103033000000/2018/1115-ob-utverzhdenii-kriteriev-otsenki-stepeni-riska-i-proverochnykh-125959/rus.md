...
| [`part002`](rus/part002.md) | Степени нарушений требований для проведения проверки на соответствие требованиям субъектов (объектов) контроля |
| [`part002-part001-t001-r001`](rus/part002-part001-t001-r001.md) | `!` таблица 1, строки 1–283 |
| [`part002-part001-t001-r002`](rus/part002-part001-t001-r002.md) | таблица 1, строки 284–465 |
| [`part002-part001-part003`](rus/part002-part001-part003.md) | part002-part001-part003 |
| [`part004`](rus/part004.md) | Перечень субъективных критериев для определения степени риска по субъективным критериям в сфере оказания медицинских услуг (помощи) ___________________________________________________________________ в соответствии со статьей 138 ___________________________________________________________________ Предпринимательского кодекса Республики Казахстан в отношении субъектов (объектов), оказывающих амбулаторно-поликлиническую помощь (первичную медико-санитарную помощь и консультативно-диагностическую помощь)________ наименование однородной группы субъектов (объектов) ___________________________________________________________________ контроля |
| [`part009`](rus/part009.md) | Перечень субъективных критериев для определения степени риска по субъективным критериям |
| [`an002`](rus/an002.md) | Перечень субъективных критериев для определения степени риска по субъективным критериям |
...
| [`part033`](rus/part033.md) | Степень нарушения требований к субъектам (объектам) контроля в сфере обращения лекарственных средств и медицинских изделий на соответствие квалификационным требованиям |
