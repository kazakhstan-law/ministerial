...
83. Графы 1 и 50 заполняется с учетом следующих особенностей.
...
86. При помещении под таможенный режим свободного склада иностранных товаров графы:
...
90. Графы 3, 5, 6, 7, 12, 14, 15, 15а, 16, 17, 17а, 23, 31, 32, 33, 34, 35, 37, 38, 40, 41, 45, 46, 47, 53, 54, А, В, С и Д заполняются в соответствии с главой 2 настоящих Правил.

91. Графы 1, 2, 9, 22, 28, 44 заполняются с учетом следующих особенностей.

    Графа 1. "Тип декларации":

    в первом подразделе графы указывается направление перемещения товаров - "ИМ";

    во втором подразделе указывается двузначный цифровой код таможенного режима в соответствии с первым разделом Приложения 3;
    ...
    в левом подразделе указывается код валюты счета согласно Приложению 10;
...
95. Графы 1, 4, 9, 47 заполняются с учетом следующих особенностей:
