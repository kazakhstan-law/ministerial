...
source: https://zan.gov.kz/client/#!/doc/118062/rus/28.12.2017
---
...
5) внесенное Продавцом финансовое обеспечение исполнения условий Договора в размере ___________________(_______________) тенге (указать наименование документа, дата и номер);
...
12. Покупатель обязан:
    ...
    5) в случае ввода в эксплуатацию объекта по использованию ВИЭ в сроки, указанных в подпункте 16) пункта 11 Договора осуществить возврат финансового обеспечения исполнения условий Договора или его части в течении 10 рабочих дней со дня предоставления письменного обращения.
...
29. Договор и аукционная цена, указанная в нем, прекращают свое действие по истечении пятнадцати лет с даты начала комплексного испытания электроустановок электростанции, при котором выработанная электроэнергия была выдана в электрические сети энергопередающей организации.
