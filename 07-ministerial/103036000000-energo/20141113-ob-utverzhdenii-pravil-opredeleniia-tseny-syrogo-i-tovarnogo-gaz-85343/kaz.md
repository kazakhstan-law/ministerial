...
caused_by:
  code: '179699'
  title: «Мемлекеттің артықшылықты құқығы шеңберінде ұлттық оператор сатып алатын шикі және тауарлық газдың шекті бағасын айқындау қағидаларын бекіту туралы» Қазақстан Республикасы Энергетика министрінің 2014 жылғы 13 қарашадағы № 121 бұйрығына өзгерістер мен толықтыру енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/179699/kaz
source: https://zan.gov.kz/client/#!/doc/85343/kaz
---
