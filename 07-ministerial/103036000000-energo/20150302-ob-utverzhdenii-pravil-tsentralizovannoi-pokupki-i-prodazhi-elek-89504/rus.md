...
caused_by:
  code: '199010'
  title: О внесении изменений и дополнения в приказ Министра энергетики Республики Казахстан от 2 марта 2015 года № 164 «Об утверждении Правил централизованной покупки и продажи единым закупщиком электрической энергии электрической энергии, произведенной объектами по использованию возобновляемых источников энергии, объектами по энергетической утилизации отходов»
  link: https://zan.gov.kz/client/#!/doc/199010/rus
...
## Заявка на заключение договора покупки электрической энергии с расчетно-финансовым центром ____________________________________________________________ (наименование и адрес юридического лица)

просит заключить договор купли-продажи электрической энергии, произведенной объектом по использованию возобновляемых источников энергии (далее - ВИЭ). Место нахождения юридического лица (его филиалов, представительств, при наличии):
...
Прогнозный коэффициент использования установленной мощности объекта по использованию ВИЭ ____.
