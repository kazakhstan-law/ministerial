...
| [`an006`](kaz/an006.md) | Қалдықтарды жинау, сұрыптау және (немесе) тасымалдау, қауіпсіз қалдықтарды қалпына келтіру және (немесе) жою жөніндегі қызметтің басталғаны немесе тоқтатылғаны туралы хабарлама |
