...
caused_by:
  code: '227251'
  title: О внесении изменений в приказ Заместителя Премьер-Министра – Министра национальной экономики Республики Казахстан от 27 мая 2025 года № 38 «Об утверждении типовой методики расчетов трансфертов общего характера»
  link: https://zan.gov.kz/client/#!/doc/227251/rus
source: https://zan.gov.kz/client/#!/doc/210804/rus
---
...
> *Сноска. Типовая методика с изменениями, внесенными приказом Заместителя Премьер-Министра – Министра национальной экономики РК от 30.06.2026 № 94 (вводится в действие с 01.07.2026).*
...
3. Объемы трансфертов общего характера определяются как сумма целевых и нецелевых трансфертов общего характера, рассчитываются по следующей формуле:
   ...
   ТОХi –трансферты общего характера i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа;

   ТОХцi– целевые трансферты общего характера i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа;

   ТОХнцi – нецелевые трансферты общего характера i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа.
...
13. Прогноз по корпоративному подоходному налогу, за исключением поступлений от субъектов крупного предпринимательства, зачисляемых в республиканский бюджет, и поступлений от организаций нефтяного сектора рассчитывается следующими методами:
    ...
    2) для определения трансфертов общего характера между республиканским бюджетом и бюджетами столицы, области, города республиканского значения на основе объема валовой добавленной стоимости (далее – ВДС) ненефтяного сектора ПСЭР по следующей формуле:
...
35. Объемы целевых трансфертов общего характера рассчитываются по следующей формуле:
    ...
    ЦТТдi – действующие целевые текущие трансферты на соответствующий плановый период, i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа;

    ЦТТобратi - обратные целевые текущие трансферты нижестоящими бюджетами в вышестоящие;

    ЦТТнi – целевые текущие трансферты i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа на новые инициативы, направленные на финансирование новых направлений расходов местного бюджета, имеющих положительное решение соответствующей бюджетной комиссии.
...
37. Объемы нецелевых трансфертов общего характера рассчитываются по следующей формуле:
    ...
    ПОДi – прогноз объема доходов i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа,

    ТЗi – прогнозный объем текущих затрат i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа,

    KЗi – прогнозный объем капитальных затрат i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа,

    ЗБРi – прогнозный объем затрат на развитие i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа.
...
38. Прогнозные объемы затрат местных бюджетов рассчитываются как сумма прогнозных объемов затрат по текущим бюджетным программам и по бюджетным программам развития с учетом установленных статьями 31, 32, 33 и 34 Бюджетного кодекса направлений расходов по функциональному признаку.
    ...
    ПОЗi – прогнозные объемы затрат местных бюджетов i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа i-й;
    ...
    КЗi – прогнозный объем капитальных затрат i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа,
    ...
    СЗi - итоговый объем затрат местных бюджетов i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа;

    ПОЗi- прогнозный объем затрат местных бюджетов i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа,
...
41. Расчет текущих затрат отдельного местного бюджета по отдельной функциональной подгруппе производится по следующей формуле:
    ...
    Рзji – расчетные текущие затраты i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа по j-й функциональной подгруппе;

    Озji – объем текущих затрат i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа по j-й функциональной подгруппе;

    Кji – коэффициент, в i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа по j-й функциональной подгруппе;

    Пji – показатели, i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа по j-й функциональной подгруппе.

42. Прогнозный объем текущих затрат местных бюджетов рассчитывается с учетом индексации, предусмотренной законами Республики Казахстан (за исключением заработной платы).

    Расчет прогнозного объема текущих затрат местных бюджетов производится по следующей формуле:

    Зv = (Зi –Зпi)*(1+И n) +Зпi, где:

    Зv – общий объем текущих затрат i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа;

    Зi – объем текущих затрат i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа;

    Зпi – объем текущих затрат на заработную плату i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа;
...
43. При расчете прогнозного объема текущих затрат для отдельных расходов применяется коэффициент прироста численности населения, который учитывает населения каждого возраста, пола, рождаемости, смертности и миграции.
    ...
    Ri- коэффициент прироста численности населения i-й столицы, области, города республиканского значения, района (города областного значения) или села, поселка, сельского округа;
...
46. Прогнозные объемы затрат на развитие местных бюджетов рассчитывается в соответствии с отраслевыми методиками их финансирования, разрабатываемыми и утверждаемыми соответствующими центральными отраслевыми государственными органами по согласованию с местными исполнительными органами, центральными уполномоченными органами по региональной политике, бюджетной политике и бюджетному планированию, и включаются в объемы нецелевых трансфертов общего характера в соответствии с типовой методикой расчетов трансфертов общего характера, с учетом минимальных стандартов и системы региональных стандартов для населенных пунктов.
    ...
    1) расчет для городов республиканского значения, столицы
       ...
       ЗБПРi - затраты на бюджетные программы развития для i-х столицы, городов республиканского значения;

       БРn – утвержденный объем бюджета развития n- го направления;

       Кn – коэффициент наивысшего показателя СРС, n- го направления который определяет на сколько % нужно дотянуть уровень столицы, города республиканского значения;
