...
| Часть | Название |
|---|---|
| [`ch001`](kaz/ch001.md) | Ұлттық әл-ауқат қорын қоспағанда, мемлекет бақылайтын акционерлік қоғамдардағы корпоративтік басқарудың үлгілік кодексі |
| [`ch002`](kaz/ch002.md) | 2-тарау. Қоғамды корпоративтік басқару қағидаттары |
| [`ch002-part013`](kaz/ch002-part013.md) | 13-параграф. Директорлар кеңесінің қызметі мен тиімділігін бағалау |
| [`ch002-part024`](kaz/ch002-part024.md) | 24-параграф. Қоғамның қызметі туралы ақпараттың ашықтығы мен ашылуы |
