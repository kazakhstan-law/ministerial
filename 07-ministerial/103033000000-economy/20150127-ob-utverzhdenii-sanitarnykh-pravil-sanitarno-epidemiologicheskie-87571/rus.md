...
| [`an008`](rus/an008.md) | Расположение контрольных точек и рецептура химических тестов для контроля температурных параметров режима работы паровых и воздушных стерилизаторов |
