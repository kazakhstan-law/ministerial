...
2. Осы Кодексте мынадай негізгі ұғымдар пайдаланылады:
   ...
   10-1) Іскерлік әдеп кодексі – директорлар кеңесі бекітетін Қоғамның лауазымды адамдары мен персоналының сақтауы үшін міндетті іскерлік әдептің негізгі құндылықтары мен стандарттарын белгілейтін қағидаттар мен қағидалар жиынтығы;
...
> *Ескерту. 2-тармаққа өзгеріс енгізілді - ҚР Премьер-Министрінің орынбасары – Ұлттық экономика министрінің 22.07.2026 № 114 (алғашқы ресми жарияланған күнінен кейін күнтізбелік он күн өткен соң қолданысқа енгізіледі) бұйрығымен.*
...
226. Мүдделер қақтығысын болғызбаудың, анықтаудың, бағалаудың және реттеудің негізгі қағидаттары директорлар кеңесі бекітетін Қоғамның Іскерлік әдеп кодексінде бекітіледі.

     Іскерлік әдеп кодексі корпоративтік құндылықтарды, әдеп қағидаттары мен мінез-құлық стандарттарын, мүдделер қақтығысын болғызбау және реттеу жөніндегі талаптарды, сондай-ақ оның ережелерінің сақталмау салдарын айқындайды.

     Қоғамның лауазымды адамдары мен персоналы Іскерлік әдеп кодексінің талаптарын сақтайды.

> *Ескерту. 226-тармақ жаңа редакцияда – ҚР Премьер-Министрінің орынбасары – Ұлттық экономика министрінің 22.07.2026 № 114 (алғашқы ресми жарияланған күнінен кейін күнтізбелік он күн өткен соң қолданысқа енгізіледі) бұйрығымен.*

#### 23-1-параграф. Іскерлік әдеп және корпоративтік мәдениет

> *Ескерту. Үлгілік кодекс 23-1-параграфпен толықтырылды - ҚР Премьер-Министрінің орынбасары – Ұлттық экономика министрінің 22.07.2026 № 114 (алғашқы ресми жарияланған күнінен кейін күнтізбелік он күн өткен соң қолданысқа енгізіледі) бұйрығымен.*

226-1. Қоғамның лауазымды адамдары мен персоналы:

қызметтік тәртіпті мүлтіксіз сақтауы, өз қызметтік міндеттерін адал, бейтарап және сапалы орындауы, жұмыс уақытын ұтымды және тиімді пайдалануы;

қызметтік міндеттерін тиімді атқаруы үшін өзінің кәсіби деңгейі мен біліктілігін арттыруы, Қазақстан Республикасының заңдарында белгіленген шектеулер мен тыйымдарды сақтауы;

жалпыға бірдей қабылданған моральдық-әдептілік нормаларын сақтауы, мемлекеттік тілге және басқа да тілдерге, халықтардың дәстүрлері мен әдет-ғұрыптарына құрметпен қарауы;

келіссөздер (кездесулер) барысында адалдық, тәртіптілік, жауапкершілік, шыдамдылық, сыпайылық, әдептілік танытуы және басқаларға құрмет көрсетуі;

ұйымның беделіне нұқсан келтіретін әрекеттерге жол бермеуі;

қоғам тарапынан негізді сынға себеп туғызбауы;

қызметтік дәреже сатысын сақтауы;

қызметтік міндеттерін орындау барысында жалпыға бірдей қабылданған іскерлік стильге сәйкес киімнің ресми, ұстамды, іскерлік стилін ұстануы;

іскерлік әдеп пен ресми мінез-құлық қағидаларын сақтауы қажет.

226-2. Лауазымды адамдар іскерлік әдеп талаптары мен мінез-құлық қағидаларының бұзылуына байланысты жағдайларды болғызбайды, анықтайды және шешеді.

Қоғамның лауазымды адамдары мен персоналының құзыретіне сәйкес іскерлік әдеп талаптарын бұзумен байланысты проблемаларға :

жағдайды түзету және кемшіліктерді жою бойынша уақтылы шаралар қабылдау;

заңнамада белгіленген тәртіппен тәртіптік сипаттағы пәрменді шараларды қабылдау және/немесе ұсыну;

тиісті құрылымдық бөлімшелермен және/немесе органдармен консультациялар өткізу арқылы ден қояды.
