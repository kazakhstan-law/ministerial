...
caused_by:
  code: '140155'
  title: «Қазақстан Республикасының құрылыс нормаларын бекіту туралы» Қазақстан Республикасы Ұлттық экономика министрлігінің Құрылыс, тұрғын үй-коммуналдық шаруашылық істері және жер ресурстарын басқару комитеті төрағасының 2016 жылғы 12 шілдедегі № 31-нқ бұйрығына өзгерістер енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/140155/kaz
