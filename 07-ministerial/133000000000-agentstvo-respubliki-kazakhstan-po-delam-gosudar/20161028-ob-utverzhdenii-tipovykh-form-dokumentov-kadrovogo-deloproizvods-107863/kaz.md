...
| Часть | Название |
|---|---|
| [`h001`](kaz/h001.md) | Мемлекеттік әкімшілік қызметтің кадрлық іс қағаздарын жүргізу құжаттарының үлгілік нысандары |
| [`part114`](kaz/part114.md) | Аттестация өткізу туралы өкім (шешім) |
