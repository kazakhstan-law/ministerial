...
caused_by:
  code: '178789'
  title: «Жерасты құрылысжайлары мен метрополитендерді салу кезінде өнеркәсіптік қауіпсіздікті қамтамасыз ету жөніндегі қағидаларды бекіту туралы» Қазақстан Республикасы Төтенше жағдайлар министрінің 2021 жылғы 15 қыркүйектегі № 450 бұйрығына өзгерістер енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/178789/kaz
source: https://zan.gov.kz/client/#!/doc/159350/kaz/20.02.2023
---
