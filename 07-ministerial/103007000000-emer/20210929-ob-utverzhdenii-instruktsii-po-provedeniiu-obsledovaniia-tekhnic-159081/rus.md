---
source: https://zan.gov.kz/client/#!/doc/159081/rus/14.07.2023
---
...
| Часть | Название |
|---|---|
| [`an000`](rus/an000.md) | Инструкция по проведению обследования технического состояния кранов мостового типа с истекшим сроком службы с целью определения возможности их дальнейшей эксплуатации |
| [`an010`](rus/an010.md) | Предельные величины местных остаточных деформаций металлоконструкций |
