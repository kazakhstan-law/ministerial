...
caused_by:
  code: '212742'
  title: «Өнеркәсіпті мемлекеттік ынталандыру шараларын көрсету кезінде қарсы міндеттемелерді айқындау және қолдану жөніндегі қағидаларды бекіту туралы» Қазақстан Республикасы Индустрия және инфрақұрылымдық даму министрінің міндетін атқарушының 2022 жылғы 27 мамырдағы № 298 бұйрығына өзгеріс енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/212742/kaz
