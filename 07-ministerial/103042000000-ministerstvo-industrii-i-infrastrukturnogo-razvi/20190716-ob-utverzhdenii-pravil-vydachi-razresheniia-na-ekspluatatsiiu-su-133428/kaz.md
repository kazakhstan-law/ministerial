...
caused_by:
  code: '141623'
  title: «Шет мемлекеттiң туын көтерiп жүзетiн кеменi Каспий теңізінің қазақстандық секторында пайдалануға рұқсат беру қағидаларын бекіту туралы» Қазақстан Республикасы Индустрия және инфрақұрылымдық даму министрінің 2019 жылғы 16 шілдедегі № 512 бұйрығына өзгерістер енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/141623/kaz
