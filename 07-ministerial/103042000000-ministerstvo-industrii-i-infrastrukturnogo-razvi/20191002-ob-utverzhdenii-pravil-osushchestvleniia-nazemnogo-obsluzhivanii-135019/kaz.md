...
caused_by:
  code: '181992'
  title: «Әуежайларда жерде қызмет көрсетуді жүзеге асыру қағидаларын бекіту туралы» Қазақстан Республикасы Индустрия және инфрақұрылымдық даму министрінің 2019 жылғы 2 қазандағы № 750 бұйрығына өзгерістер мен толықтыру енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/181992/kaz
source: https://zan.gov.kz/client/#!/doc/135019/kaz/24.05.2023
---
