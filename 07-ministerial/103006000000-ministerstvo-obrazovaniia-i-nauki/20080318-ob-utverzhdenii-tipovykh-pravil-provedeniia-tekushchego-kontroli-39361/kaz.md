...
caused_by:
  code: '43839'
  title: '"Білім алушылардың үлгерімін ағымдағы бақылау, аралық және қорытынды мемлекеттік аттестаттау жүргізудің үлгі ережесін бекіту туралы" Қазақстан Республикасы Білім және ғылым министрінің 2008 жылғы 18 наурыздағы N 125 бұйрығына өзгерістер мен толықтырулар енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/43839/kaz
