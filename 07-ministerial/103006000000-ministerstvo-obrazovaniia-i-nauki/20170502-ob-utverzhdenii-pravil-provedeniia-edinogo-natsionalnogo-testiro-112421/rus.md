...
| Часть | Название |
|---|---|
| [`an000`](rus/an000.md) | Правила проведения единого национального тестирования |
| [`an005-1`](rus/an005-1.md) | Перечень групп образовательных программ с указанием общепрофессиональных и специальных дисциплин единого национального тестирования для поступающих по образовательным программам высшего образования, предусматривающим сокращенные сроки обучения |
