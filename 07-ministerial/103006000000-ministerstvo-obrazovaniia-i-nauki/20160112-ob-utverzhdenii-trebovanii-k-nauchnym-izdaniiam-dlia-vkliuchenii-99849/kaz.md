...
caused_by:
  code: '197841'
  title: «Ғылыми қызметтің нәтижелерін жариялау үшін ұсынылатын басылымдар тізбесіне қосу үшін ғылыми басылымдарға қойылатын талаптарды бекіту туралы» Қазақстан Республикасы Білім және ғылым министрінің 2016 жылғы 12 қаңтардағы № 20 бұйрығына өзгерістер енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/197841/kaz
