...
caused_by:
  code: '205352'
  title: Азаматтық қорғаудың мемлекеттік жүйесін ұйымдастыру және оның қызметі қағидаларын бекіту туралы Қазақстан Республикасы Ішкі істер министрінің 2015 жылғы 24 ақпандағы № 149 бұйрығына өзгеріс енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/205352/kaz
source: https://zan.gov.kz/client/#!/doc/90304/kaz/26.12.2024
---
