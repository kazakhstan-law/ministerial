...
| [`an002`](kaz/an002.md) | Ғимараттардың, құрылыстардың және өрт бөліктерінің құрылыс конструкцияларының отқа төзімділік дәрежесінің және отқа төзімділік шегінің сәйкестігі |
| [`an009`](kaz/an009.md) | Көлік құралдарын сақтау мен қызмет көрсету орындарына дейін өртке қарсы қашықтықтар |
| [`an014`](kaz/an014.md) | Объектілерді бастапқы өрт сөндіру құралдарымен қамтамасыз ету нормалары |
| [`an017`](kaz/an017.md) | Заттар мен материалдардың жарылыс-өрт және өрт қауіптілігі көрсеткіштері |
| [`an019`](kaz/an019.md) | Өртке қарсы кедергілердің отқа төзімділік шегі |
