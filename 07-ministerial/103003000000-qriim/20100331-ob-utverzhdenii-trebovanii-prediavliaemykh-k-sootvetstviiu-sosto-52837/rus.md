...
caused_by:
  ...
  link: https://zan.gov.kz/client/#!/doc/132734/rus
source: https://zan.gov.kz/client/#!/doc/52837/rus/20.06.2019
---
...
1. Категории годности к воинской службе сотрудников и кандидатов для прохождения службы в правоохранительных органах, поступающих в специальные (военные) учебные заведения (далее - сотрудники) определены в графах согласно Приложениям 1–90 к настоящим Требованиям:
   ...
   2) графа II:
      ...
      сотрудники строевых подразделений патрульной полиции (несущие службу на открытом воздухе);
