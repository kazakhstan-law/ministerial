...
## 2. Күзетілетін объектілер мен азаматтардың пәтерлерінен, оның ішінде күзет қызметінің мемлекеттік емес күзет субъектілері күзететін объектілерден "Дабыл" белгісі түскен кезіндегі полиция кешенді күштері патрульдік-күзет нарядтарының іс-әрекеттері
...
## 6. Күзетілетін пәтерден "Дабыл" белгісін алған кездегі полиция кешенді күштерінің патрульдік-күзет нарядтарының іс-әрекеттері
