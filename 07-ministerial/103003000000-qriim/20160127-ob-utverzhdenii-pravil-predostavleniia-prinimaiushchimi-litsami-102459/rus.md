...
caused_by:
  code: '168501'
  title: О внесении изменения в приказ Министра внутренних дел Республики Казахстан от 27 января 2016 года № 83 «Об утверждении Правил предоставления принимающими лицами информации о пребывающих у них иммигрантах, а также транзитного проезда иностранцев и лиц без гражданства по территории Республики Казахстан»
  link: https://zan.gov.kz/client/#!/doc/168501/rus
source: https://zan.gov.kz/client/#!/doc/102459/rus
---
...
5. Уведомления отправляются следующими способами:
   ...
   через информационную систему «e-Qonag» посредством веб-сайта www.eqonaq.kz пользователями указанной системы.

> *Сноска. Пункт 5 в редакции приказа Министра внутренних дел РК от 30.05.2022 № 404 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования).*
