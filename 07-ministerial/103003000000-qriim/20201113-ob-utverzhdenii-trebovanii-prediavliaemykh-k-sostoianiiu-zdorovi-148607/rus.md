...
caused_by:
  ...
  link: https://zan.gov.kz/client/#!/doc/179746/rus
...
2. Требования по показателям (критериям) состояния здоровья и развития, категории годности кандидатов на службу (учебу), сотрудников правоохранительных органов изложены в соответствии с приложением к настоящим Требованиям к состоянию здоровья.
   ...
   3) графа III:
      ...
      > *Сноска. Пункт 2 в редакции приказов Министра внутренних дел РК от 18.05.2022 № 355 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования); от 05.04.2023 № 277 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования).*
