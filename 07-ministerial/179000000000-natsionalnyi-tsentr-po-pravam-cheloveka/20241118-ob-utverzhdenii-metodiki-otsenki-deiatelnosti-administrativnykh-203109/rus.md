...
source: https://zan.gov.kz/client/#!/doc/203109/rus/18.11.2024
---
...
1. Настоящая Методика оценки деятельности административных государственных служащих корпуса «Б» Национального центра по правам человека (далее – НЦПЧ) и его представительств (далее – Методика) разработана в соответствии с пунктом 5 статьи 33 Закона Республики Казахстан «О государственной службе Республики Казахстан» и определяет порядок оценки деятельности административных государственных служащих корпуса «Б» Национального центра по правам человека (далее – НЦПЧ) и его представительств.
...
2. Основные понятия, используемые в настоящей Методике:
   ...
   4) руководитель структурного подразделения/государственного органа – административный государственный служащий корпуса «Б» соответствующей категории;

   5) служащий корпуса «Б» – лицо, занимающее административную государственную должность корпуса «Б» НЦПЧ и его представительств, за исключением руководителя структурного подразделения/государственного органа;
...
15. Результаты оценки являются строго конфиденциальной информацией и не подлежат разглашению третьим лицам, за исключением случаев, когда НЦПЧ обязан раскрыть данную информацию в соответствии с Законом Республики Казахстан «О доступе к информации».
...
```
          ...
          (государственного органа) ______________________
...
(оцениваемый период) ___________________________________
```
...
(далее – оценка) предлагаем Вам оценить своих коллег методом ранжирования по 5-
балльной шкале.
...
Результаты оценки: _____________________________
