...
| Часть | Название |
|---|---|
| [`an001`](kaz/an001.md) | Әлеуметтік медициналық сақтандыру қорының бақылау функцияларын қамтамасыз ету үшін қаржылық және өзге де есептілікті ұсыну тізбесі, мерзімдері |
| [`an013`](kaz/an013.md) | «Халықты міндетті әлеуметтік медициналық сақтандыру жүйесімен қамту жөніндегі есеп» әкімшілік деректерді жинауға арналған нысанды толтыру бойынша түсіндірме |
