...
6. Санитариялық-эпидемияға қарсы, санитариялық-профилактикалық іс-шаралар жүргізілетін жерлерде және (немесе) объектілерде COVID-19-дың таралуына жол бермеу үшін:
   ...
   2) жеке қорғаныш құралдарын, оның ішінде маскалар мен антисептиктерді пайдалану;

   3) температураны қашықтықтан өлшеуге арналған құралдарды пайдалану;

   4) адамдар арасындағы қашықтық;

   5) үй-жайларды желдету;
...
10. Температураны өлшеу, желдету және адамдардың арасындағы қашықтық үшін мынадай қауіпсіздік шаралары қамтамасыз етіледі:

    1) азық-түлік дүкендеріне (базарларға) барған кезде келуші (клиент) мен жұмыскер арасында кемінде 1 метр арақашықтық сақталады;

    2) жұмыстар мен қызметтерді көрсету орындарына бару алдын ала жазылу бойынша жүзеге асырылады;

    3) қоғамдық тамақтану пункттерінде үстелдер бір-бірінен кемінде бір метр орналастырылады;
    ...
    5) қызметкерлер бір үй-жайда бір-бірінен кемінде бір метр арақашықтықта орналасады;
    ...
    7) ойын-сауық іс-шараларын өткізу кезінде үй-жайдың жобалық қуатының 50%-ынан аспаған кезде келушілердің бір мезгілде келуіне болады;

    8) ашық ауада жүріп-тұру (қозғалыс) үш адамнан аспайтын топтармен немесе бас мемлекеттік санитариялық дәрігерлер белгілеген талаптарды сақтай отырып жүзеге асырылады;

    9) залдарды топтармен толтыру жобалық қуаттың 50%-ынан аспайды;

    10) жабық үй-жайларға, сондай-ақ қоғамдық көлікке кіру қорғаныш маскаларын кию арқылы жүзеге асырылады;

    11) қызметтік көлікті қоса алғанда, қоғамдық көлік жүргізушілері мен кондукторларында қолды өңдеуге арналған антисептиктердің және қорғаныш құралдарының (маскалар мен қолғаптар) болуы;

    12) адамдар көп жиналатын орындарда бір-бірінен кемінде бір метр қашықтық сақталады;

    13) тамақ өнімдерін өткізу өлшеп-оралған түрде жүзеге асырылады (кесілмеген көкөністер мен жемістерді қоспағанда);

    14) теміржол және автовокзалдардың кіреберістерінде тепловизорлар мен жеке қорғаныш құралдары пайдаланылады.

11. Шектеу іс-шаралары, оның ішінде карантин енгізілген жерлерде және (немесе) объектілерде мыналар жүзеге асырылмайды:

    1) ұжымдық және бұқаралық іс-шаралар;

    2) 65 жастан асқан тұрғындар мен 3 адамнан артық топтардың жүріп-тұруы (отбасы мүшелерін қоспағанда);

    3) әлеуметтік қашықтықты сақтай отырып, 3 адамнан аспайтын топтармен немесе бір отбасы мүшелерімен ойын-сауық объектілері жоқ саябақтарға, алаңдар мен скверлерге, жағалауларға және халықтың өзге де демалыс орындарына бару.
...
6. «Денсаулық сақтау объектілеріне қойылатын санитариялық-эпидемиологиялық талаптар» санитариялық қағидаларын бекіту туралы» Қазақстан Республикасы Денсаулық сақтау министрінің 2017 жылғы 31 мамырдағы № 357 бұйрығына (Қазақстан Республикасының Нормативтік құқықтық актілерді мемлекеттік тіркеу тізілімінде 2017 жылғы 27 қыркүйекте № 15760 болып тіркелген, Қазақстан Республикасының нормативтік құқықтық актілерінің эталондық бақылау банкінде 2017 жылғы 18 қазанда жарияланған) мынадай толықтырулар енгізілсін:

   көрсетілген бұйрықпен бекітілген «Денсаулық сақтау объектілеріне қойылатын санитариялық-эпидемиологиялық талаптар» санитариялық қағидаларында:
   ...
   осы тізбеге 17, 18, 19 және 20-қосымшаларға сәйкес 8, 9, 10, 11-қосымшалармен толықтырылсын.
...
8. «Жолаушылар мен жүктерді тасымалдауға арналған көлік құралдарына қойылатын санитариялық-эпидемиологиялық талаптар» санитариялық қағидаларын бекіту туралы» Қазақстан Республикасы Денсаулық сақтау министрінің 2017 жылғы 31 мамырдағы № 359 бұйрығына (Нормативтік құқықтық актілерді мемлекеттік тіркеу тізілімінде № 15695 болып тіркелген, Қазақстан Республикасының нормативтік құқықтық актілерінің эталондық бақылау банкінде 2017 жылғы 9 қазанда жарияланған) мынадай өзгерістер мен толықтырулар енгізілсін:

   көрсетілген бұйрықпен бекітілген «Жолаушылар мен жүктерді тасымалдауға арналған көлік құралдарына қойылатын санитариялық-эпидемиологиялық талаптар» санитариялық қағидаларында:
   ...
   4-қосымша осы тізбеге 22-қосымшаға сәйкес жаңа редакцияда жазылсын;

   11-қосымша осы тізбеге 23-қосымшаға сәйкес жаңа редакцияда жазылсын;

   осы тізбеге 24-қосымшаға сәйкес 25-қосымшамен толықтырылсын.
...
13. «Өндіріс және тұтыну қалдықтарын жинауға, пайдалануға, қолдануға, залалсыздандыруға, тасымалдауға, сақтауға және көмуге қойылатын санитариялық-эпидемиологиялық талаптар» санитариялық қағидаларын бекіту туралы» Қазақстан Республикасы Денсаулық сақтау министрінің 2018 жылғы 23 сәуірдегі № 187 бұйрығына (Нормативтік құқықтық актілерді мемлекеттік тіркеу тізілімінде № 17242 болып тіркелген, Қазақстан Республикасының нормативтік құқықтық актілерінің эталондық бақылау банкінде 2018 жылғы 10 тамызда жарияланған) мынадай өзгерістер мен толықтырулар енгізілсін:

    көрсетілген бұйрықпен бекітілген «Өндіріс және тұтыну қалдықтарын жинауға, пайдалануға, қолдануға, залалсыздандыруға, тасымалдауға, сақтауға және көмуге қойылатын санитариялық-эпидемиологиялық талаптар» санитариялық қағидаларында:
    ...
    осы тізбеге 31-қосымшаға сәйкес 5-қосымшамен толықтырылсын.
