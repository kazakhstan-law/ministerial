...
| [`an001_002`](rus/an001_002.md) | Пояснение по заполнению формы, предназначенной для сбора административных данных «Информация по прямым фактическим затратам на один пролеченный случай» |
| [`an010`](rus/an010.md) | Форма, предназначенная для сбора административных данных «Информация о выполненных хирургических операциях» |
| [`an001_023`](rus/an001_023.md) | Форма, предназначенная для сбора административных данных «Информация о затратах на обновление основных средств» |
| [`an015`](rus/an015.md) | Глава 1. Общие положения |
| [`an018-1`](rus/an018-1.md) | Пояснение по заполнению формы, предназначенной для сбора административных данных «Структура расходов субъекта здравоохранения для расчета накладных расходов» |
| [`part046`](rus/part046.md) | Таблица максимальных баллов для субъектов первичной медико-санитарной помощи в разрезе профилей территориальных участков |
