...
| [`an011`](rus/an011.md) | Пояснение по заполнению формы, предназначенной для сбора административных данных «Калькуляция стоимости медицинских услуг» |
| [`an015`](rus/an015.md) | Глава 1. Общие положения |
| [`an019`](rus/an019.md) | Пояснение по заполнению формы, предназначенной для сбора административных данных «Структура расходов субъекта здравоохранения для расчета накладных расходов» |
| [`part045`](rus/part045.md) | Таблица максимальных баллов для субъектов первичной медико-санитарной помощи в разрезе профилей территориальных участков |
