...
caused_by:
  code: '81255'
  title: '"Тегін медициналық көмектің кепілдік берілген көлемі шеңберінде дәрілік заттардың, медициналық мақсаттағы бұйымдардың бағаларын мониторинг ұйымдастыру мен жүзеге асыру, сондай-ақ оларды қалыптастыру қағидасын бекіту туралы" Қазақстан Республикасы Денсаулық сақтау министрінің 2013 жылғы 12 сәуірдегі № 223 бұйрығына өзгеріс енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/81255/kaz
