...
caused_by:
  code: '91859'
  title: '"Тегін медициналық көмектің кепілдік берілген көлемі шеңберінде дәрілік заттардың, медициналық мақсаттағы бұйымдардың бағаларына мониторинг ұйымдастыру мен жүзеге асыру, сондай-ақ оларды қалыптастыру қағидасын бекіту туралы" Қазақстан Республикасы Денсаулық сақтау Министрінің 2013 жылғы 12 сәуірдегі № 223 бұйрығына өзгерістер мен толықтыру енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/91859/kaz
