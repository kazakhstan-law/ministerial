...
caused_by:
  code: '179870'
  title: «Клиникалық база, денсаулық сақтау саласындағы білім беру ұйым клиникасы, университеттік аурухана, резидентура базасы, интеграцияланған академиялық медициналық орталық туралы ережелерді және оларға қойылатын талаптарды бекіту туралы» Қазақстан Республикасы Денсаулық сақтау министрінің 2020 жылғы 21 желтоқсандағы № ҚР ДСМ-304/2020 бұйрығына өзгерістер мен толықтырулар енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/179870/kaz
source: https://zan.gov.kz/client/#!/doc/150229/kaz/14.04.2023
---
