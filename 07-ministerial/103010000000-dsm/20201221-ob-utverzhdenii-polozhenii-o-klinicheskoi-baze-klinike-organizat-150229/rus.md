...
source: https://zan.gov.kz/client/#!/doc/150229/rus/21.12.2020
---
...
В соответствии с пунктом 4 статьи 220 Кодекса Республики Казахстан от 7 июля 2020 года «О здоровье народа и системе здравоохранения» и пунктом 5 статьи 40 Закона Республики Казахстан от 27 июля 2007 года «Об образовании», ПРИКАЗЫВАЮ:
...
1. Положение о клинической базе и требования, предъявляемые к ней разработаны (далее - Положение) в соответствии с пунктом 4 статьи 220 Кодекса Республики Казахстан от 7 июля 2020 года «О здоровье народа и системе здравоохранения», пунктом 5 статьи 40 Закона Республики Казахстан от 27 июля 2007 года «Об образовании».
...
1. Положение о клинике организации образования в области здравоохранения и требования, предъявляемые к ней (далее - Положение) разработаны в соответствии с пунктом 4 статьи 220 Кодекса Республики Казахстан от 7 июля 2020 года «О здоровье народа и системе здравоохранения», пунктом 5 статьи 40 Закона Республики Казахстан от 27 июля 2007 года «Об образовании».

2. В настоящем Положении используются следующие термины и определения:

   1) вторичный уровень – уровень оказания медицинской помощи профильными специалистами, осуществляющими специализированную медицинскую помощь в амбулаторных, стационарозамещающих и стационарных условиях, в том числе по направлению специалистов, оказывающих медицинскую помощь на первичном уровне;
   ...
   3) обучающиеся – студенты, слушатели программ дополнительного образования организации образования в области здравоохранения;

   4) оборудование – медицинские изделия, учебное оборудование (муляжи), используемые организацией образования в области здравоохранения и клиникой организации образования в области здравоохранения в лечебном и (или) образовательном процессах;

   5) организация образования в области здравоохранения – организация образования, реализующая образовательные программы по направлениям подготовки «Здравоохранение» и (или) «Междисциплинарные программы, связанные со здравоохранением и социальным обеспечением (медицина)»;

   6) учебные кабинеты – помещения клиники организации образования в области здравоохранения, предназначенные для использования организацией образования в области здравоохранения в целях образовательного процесса;
   ...
   8) дуальное обучение – форма подготовки кадров, сочетающей обучение в организации образования с обязательными периодами производственного обучения и профессиональной практики на предприятии (в организации) с предоставлением рабочих мест и компенсационной выплатой обучающимся при равной ответственности предприятия (организации), учебного заведения и обучающегося;
   ...
   10) врач-резидент – врач, обучающийся в рамках образовательной программы резидентуры и работающий в медицинской организации под надзором наставника;
...
3. Статус КОООЗ получают:
   ...
   2) организация здравоохранения, оказывающая медицинскую помощь вторичного уровня, на основании решения местного исполнительного органа области, города республиканского значения и столицы при наличии согласия собственника и уполномоченного органа.
...
9. Требованиями к КОООЗ являются:
   ...
   1) оказание медицинских услуг вторичного уровня;
...
1. Положение об университетской больнице и требования, предъявляемые к ней (далее – Положение) разработаны в соответствии с пунктом 4 статьи 220 Кодекса Республики Казахстан от 7 июля 2020 года «О здоровье народа и системе здравоохранения», пунктом 5 статьи 40 Закона Республики Казахстан от 27 июля 2007 года «Об образовании».
...
3. Университетские больницы имеют одну из следующих форм взаимодействия с организацией высшего и (или) послевузовского медицинского образования:
   ...
   2) являются многопрофильной организацией здравоохранения, оказывающей медицинскую помощь вторичного уровня:
...
1. Положение о базе резидентуры и требования, предъявляемые к ней разработаны в соответствии с подпунктом 217 пункта 1 статьи 1 Кодекса Республики Казахстан от 7 июля 2020 года «О здоровье народа и системе здравоохранения», пунктом 5 статьи 40 Закона Республики Казахстан от 27 июля 2007 года «Об образовании».
...
1. Положение об интегрированном академическом медицинском центре и требования, предъявляемые (далее – Положение) к нему разработаны в соответствии с пунктом 4 статьи 220 Кодекса Республики Казахстан от 7 июля 2020 года «О здоровье народа и системе здравоохранения», пунктом 5 статьи 40 Закона Республики Казахстан от 27 июля 2007 года «Об образовании».
