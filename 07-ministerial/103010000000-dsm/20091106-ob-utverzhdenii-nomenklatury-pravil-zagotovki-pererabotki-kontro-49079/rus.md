...
caused_by:
  code: '67521'
  title: О внесении изменений в приказ и.о. Министра здравоохранения Республики Казахстан от 6 ноября 2009 года № 666 "Об утверждении Номенклатуры, Правил заготовки, переработки, хранения, реализации крови и ее компонентов, а также Правил хранения, переливания крови, ее компонентов и препаратов"
  link: https://zan.gov.kz/client/#!/doc/67521/rus
