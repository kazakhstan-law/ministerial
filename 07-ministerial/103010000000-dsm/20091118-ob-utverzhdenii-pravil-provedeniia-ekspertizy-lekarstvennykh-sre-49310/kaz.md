...
| [`part008`](kaz/part008.md) | 8. Дәрілік заттың мамандандырылған фармакологиялық сараптамасын жүргізу тәртібі |
...
| [`part021`](kaz/part021.md) | 1. Дәрілік заттың тіркеу деректеріне енгізілген 1 типті өзгерістер |
...
| [`part036`](kaz/part036.md) | Қазақстан Республикасында тіркеу куәлігінің жарамдылық мерзімінде медициналық мақсаттағы бұйымдардың және (немесе) медициналық техниканың тіркеу деректеріне енгізілетін жаңа тіркеуді қажет етпейтін 1 типті өзгерістер |
