...
Для аэродромов категории "А":

1\) предварительная подготовка с контролем готовности.

Для аэродромов категории "В":

1\) предварительная подготовка с контролем готовности;

2\) тренировка на тренажере, сертифицированном для этих целей или;

3\) ознакомительный полет в качестве обзервера или под наблюдением инструктора (для пилотов - командира ВС).

6\. КВС и штурман допускаются к полетам на данный аэродром и по маршруту после ознакомительного полета в качестве "обзервера" или под контролем инструктора, второй пилот - после ознакомительного полета под наблюдением КВС.

7\. Для аэродромов категории "С" дополнительно к требованиям по подготовке для аэродромов категории "В" эксплуатант разрабатывает специальные процедуры в соответствии с требованиями государства принадлежности аэродрома, которые вносится в РПП организации гражданской авиации.

8\. Специальные процедуры, как минимум, должны включать:

1) расчет и утверждение схем аварийных маневров и минимальных градиентов набора высоты и,

2) расчет взлетно-посадочных характеристик и ограничения взлетной и посадочных масс и,

3) любую другую информацию, необходимую экипажу для выполнения полетов и,

4) дополнительные методы ознакомления с районом аэродрома (облет схем и района аэродрома на комплексном тренажере, сертифицированном для этих целей, ознакомительный полет в качестве "обзервера").

9\. Допуск к полетам на аэродромы категории "С" оформляется после выполнения проверочного полета под контролем инструктора с записью в летную книжку.

10\. Срок действия маршрутной и аэродромной квалификации для аэродромов категории "А" - 12 календарных месяцев, для категорий "В" и "С" - 6 календарных месяцев от даты получения квалификации или даты выполнения полета по данному маршруту или на аэродром.

11\. Маршрутную и аэродромную подготовку членов экипажей допускается выполнять в процессе тренировки в рейсовых условиях по программам стажировки.
