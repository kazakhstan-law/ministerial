...
caused_by:
  code: '108301'
  title: '"Теңіз кемелерінің жүк маркасы туралы қағидасын бекіту туралы" Қазақстан Республикасы Көлік және коммуникация министрінің міндетін атқарушының 2011 жылғы 21 сәуірдегі № 214 бұйрығына өзгерістер мен толықтырулар енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/108301/kaz
...
Қоқыс салғыштардың ішкі ұшы жазғы жүк маркасы бойынша кеменің шөгінді кезінде ватерсызықтан 1000 мм кем болмайтындай көтерілетіндей етіп орналастырылуы және кеменің осы қалпынан кез келген борт жағына 8,50 қисаю бұрышына дейін бағыттауы кезінде ватерсызықтан жоғары болып қалу ұсыналады.
