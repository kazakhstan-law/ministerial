...
> *Сноска. Приложение в редакции приказа и.о. Министра сельского хозяйства РК от 06.06.2024 № 189 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования).*
...
Индекс формы административных данных: № 1-ЗЗ

Периодичность: квартально

Отчетный период: _____ квартал 20__года

Круг лиц, представляющих информацию: оператор по зерновому рынку

Срок представления формы административных данных: ежеквартально, в срок до 5 числа месяца, следующего за отчетным кварталом
...
Пояснение по заполнению формы, предназначенной для сбора административных данных «Отчет о наличии резервного запаса зерна» приведено в приложении к настоящей форме.
...
## Пояснение по заполнению формы, предназначенной для сбора административных данных «Отчет о наличии резервного запаса зерна»

### Глава 1. Общие положения

1. Настоящее пояснение определяет единые требования по заполнению формы, предназначенной для сбора административных данных «Отчет о наличии резервного запаса зерна» (далее – Форма).
...
5. В графе 2 указывается бизнес-идентификационный номер хлебоприемного предприятия.

6. В графе 3 указывается наименование хлебоприемного предприятия.

7. В графе 4 указывается адрес хлебоприемного предприятия.

8. В графе 5 указывается код по классификатору административно-территориальных объектов.

9. В графе 6 указывается объем зерна, хранящегося на хлебоприемном предприятии, в тоннах.
