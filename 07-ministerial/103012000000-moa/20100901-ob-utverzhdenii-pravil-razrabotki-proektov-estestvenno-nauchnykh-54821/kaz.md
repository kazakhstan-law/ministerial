...
caused_by:
  code: '225506'
  title: «Ерекше қорғалатын табиғи аумақтарды құру және кеңейту жөніндегі жаратылыстану-ғылыми және техникалық-экономикалық негіздемелерінің жобаларын әзірлеу, сондай-ақ техникалық-экономикалық негіздемені түзету қағидасын бекіту туралы» Қазақстан Республикасы Ауыл шаруашылығы министрінің міндетін атқарушының 2010 жылғы 1 қыркүйектегі № 558 бұйрығына өзгерістер енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/225506/kaz
source: https://zan.gov.kz/client/#!/doc/54821/kaz
---
