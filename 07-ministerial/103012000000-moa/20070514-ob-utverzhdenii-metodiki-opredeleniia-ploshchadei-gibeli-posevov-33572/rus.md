...
caused_by:
  code: '53872'
  title: О внесении изменений и дополнения в приказ Министра сельского хозяйства Республики Казахстан от 14 мая 2007 года № 316 "Об утверждении Методики определения площадей гибели посевов и Методики определения предполагаемого дохода от урожая"
  link: https://zan.gov.kz/client/#!/doc/53872/rus
