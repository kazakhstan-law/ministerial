...
caused_by:
  code: '96392'
  title: «Ветеринария саласындағы мемлекеттік көрсетілетін қызметтер стандарттарын бекіту туралы» Қазақстан Республикасы Ауыл шаруашылығы министрінің 2015 жылғы 6 мамырдағы  № 7-1/418 бұйрығына өзгерістер мен толықтырулар енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/96392/kaz
source: https://zan.gov.kz/client/#!/doc/94065/kaz/24.11.2015
---
