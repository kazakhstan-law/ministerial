...
source: https://zan.gov.kz/client/#!/doc/132234/kaz/31.05.2019
---
...
1. Осы су тарту және ағызу құрылыстарының балықтарды қорғау құрылғыларына қойылатын талаптар (бұдан әрі – Талаптар) «Жануарлар дүниесiн қорғау, өсiмiн молайту және пайдалану туралы» 2004 жылғы 9 шілдедегі Қазақстан Республикасы Заңының 9-бабы 1-тармағының 20) тармақшасына сәйкес әзірленді және су тарту және ағызу құрылыстарының балықтарды қорғау құрылғыларына қойылатын талаптарды айқындайды.
