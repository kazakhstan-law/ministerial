...
caused_by:
  code: '160092'
  title: «Ветеринариялық препараттарды, жемшөп қоспаларын байқаудан өткізу және тіркеу сынақтарын өткізу қағидаларын бекіту туралы» Қазақстан Республикасы Ауыл шаруашылығы министрінің 2014 жылғы 24 қарашадағы № 7-1/611 бұйрығына өзгерістер енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/160092/kaz
