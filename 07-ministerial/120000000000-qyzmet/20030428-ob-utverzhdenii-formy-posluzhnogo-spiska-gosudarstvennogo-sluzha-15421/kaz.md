...
caused_by:
  code: '60302'
  title: '"Мемлекеттік Қызметшілердің қызмет тізімі үлгісін бекіту туралы" Қазақстан Республикасы Мемлекеттік қызмет істері агенттігі Төрағасының 2003 жылғы 29 сәуірдегі № 02-01-02/59 бұйрығына өзгеріс енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/60302/kaz
