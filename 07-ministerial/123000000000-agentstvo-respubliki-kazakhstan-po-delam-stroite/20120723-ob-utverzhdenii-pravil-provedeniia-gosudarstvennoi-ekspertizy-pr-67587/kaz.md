...
caused_by:
  code: '80163'
  title: '"Сараптамалық сүйемелдеу режимінде құрылыс жобаларына мемлекеттік сараптама жүргізу қағидасын бекіту туралы" Қазақстан Республикасы Құрылыс және тұрғын үй-коммуналдық шаруашылық істері агенттігі төрағасының 2012 жылғы 23 шілдедегі № 356 бұйрығына өзгеріс енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/80163/kaz
source: https://zan.gov.kz/client/#!/doc/67587/kaz/14.04.2014
---
