...
caused_by:
  code: '9253'
  title: '"Мемлекеттiк мекемелердегi бухгалтерлiк есеп жөнiндегi нұсқаулықты бекiту туралы" Қазақстан Республикасының Қаржы министрлiгi Қазынашылық департаментiнiң 1998 жылғы 27 қаңтардағы N 30 бұйрығына өзгерiстер мен толықтырулар енгізу туралы'
  link: https://zan.gov.kz/client/#!/doc/9253/kaz
