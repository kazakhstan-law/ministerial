...
caused_by:
  code: '175832'
  title: О внесении изменений в приказ Председателя Комитета по статистике Министерства национальной экономики Республики Казахстан от 15 декабря 2015 года № 209 «Об утверждении Методики по формированию показателей по статистике внутренней торговли»
  link: https://zan.gov.kz/client/#!/doc/175832/rus
source: https://zan.gov.kz/client/#!/doc/98705/rus
---
