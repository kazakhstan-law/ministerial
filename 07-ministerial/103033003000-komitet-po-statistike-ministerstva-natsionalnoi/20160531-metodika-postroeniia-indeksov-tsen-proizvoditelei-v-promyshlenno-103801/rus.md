---
version_id: '103801_96732'
act_code: '103801'
language: rus
title: Методика построения индексов цен производителей в промышленности
requisite: Приказ Председателя Комитета по статистике Министерства национальной экономики Республики Казахстан от 31 мая 2016 года № 98. Зарегистрирован в Министерстве юстиции Республики Казахстан 29 июня 2016 года № 13845
form: ПРИК
type_codes:
- МЕТ
- ПРИК
...
registry_number: '103801'
source: https://zan.gov.kz/client/#!/doc/103801/rus/31.05.2016
---
...
2. В настоящей Методике используются понятия в значениях, определенных в Законе, и следующие определения:
   ...
   3) регистрация цен – метод сбора информации об уровне цен на товары, продукцию, услуги, проводимый по выборочной репрезентативной совокупности базовых объектов;
...
10. Индексы цен производителей в промышленности отражают изменения цен на производство и приобретение продукции, услуг у единиц, работающих в том или ином классе промышленной деятельности в соответствии с «Общим классификатором видов экономической деятельности» (далее – ОКЭД), разработанным и утвержденным в соответствии с Законом Республики Казахстан от 9 ноября 2004 года «О техническом регулировании» (далее – Закон о техрегулировании).

11. В соответствии с ОКЭД промышленная деятельность классифицируется в секциях B «Горнодобывающая промышленность и разработка карьеров», С «Обрабатывающая промышленность», D «Электроснабжение, подача газа, пара и воздушное кондиционирование», E «Водоснабжение, канализационная система, контроль над сбором и распределением отходов».

12. Для детализации видов продукции, услуг применяется «Статистический классификатор промышленной продукции (товаров, услуг)» (далее – СКПП) и для индекса цен приобретения «Статистический классификатор продукции (услуг) сельского, лесного и рыбного хозяйства» (далее – СКПСХ), разработанные и утвержденные в соответствии с Законом о техрегулировании.
...
34. Регистрация цен осуществляется на ежемесячной основе согласно статистической форме общегосударственного статистического наблюдения – «Отчет предприятия-производителя о ценах на промышленную продукцию (товары, услуги) и ценах приобретения продукции производственно-технического назначения» (индекс 1-ЦП), утверждаемой в соответствии с подпунктом 8) статьи 12 Закона (далее – Форма).

    Основанием для заполнения Формы служат документы бухгалтерского учета: договора, платежные требования, накладные, доверенности, счета-фактуры, договора и другие документы.
...
36. При регистрации цен принимаются меры по соблюдению конфиденциальности и использованию первичных статистических данных исключительно для статистических целей, гарантируемые действующим законодательством в области государственной статистики. Осуществляется проверка достоверности первичных статистических данных, их уточнение, проводится логический и визуальный контроль ценовой информации.
    ...
    При изменении цен на обследуемые товары, услуги указываются причины их изменения, в отдельных случаях для подтверждения достоверности первичных статистических данных одновременно со статистической формой представляется дополнительная информация: договора, платежные требования, накладные, счет-фактуры и иные документы бухгалтерского учета.
...
52. Процесс построения схемы взвешивания индекса цен производителей включает следующие последовательные операции:
    ...
    3) распределение стоимости промышленной продукции в зависимости от канала реализации.
       ...
       Среднегодовая стоимость произведенной промышленной продукции определяется по полному перечню видов товаров, услуг СКПП и распределяется по соответствующим подвидам, отобранным для ценового наблюдения. По неохваченным подвидам продукции (товаров, услуг) стоимостные данные добавляются к обследуемым подвидам или пропорционально распределяются по всем составляющим элементам.
