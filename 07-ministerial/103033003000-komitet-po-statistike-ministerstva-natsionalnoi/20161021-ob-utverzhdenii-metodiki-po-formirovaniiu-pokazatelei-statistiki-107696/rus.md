...
caused_by:
  code: '165375'
  title: О внесении изменений в приказ Председателя Комитета по статистике Министерства национальной экономики Республики Казахстан от 21 октября 2016 года № 245 «Об утверждении Методики по формированию показателей строительной деятельности»
  link: https://zan.gov.kz/client/#!/doc/165375/rus
source: https://zan.gov.kz/client/#!/doc/107696/rus/14.03.2022
---
