...
caused_by:
  code: '161327'
  title: О внесении изменений в приказ исполняющего обязанности Председателя Комитета по статистике Министерства национальной экономики Республики Казахстан от 25 декабря 2015 года № 224 «Об утверждении Методики формирования статистических показателей по животноводству»
  link: https://zan.gov.kz/client/#!/doc/161327/rus
source: https://zan.gov.kz/client/#!/doc/98299/rus
---
