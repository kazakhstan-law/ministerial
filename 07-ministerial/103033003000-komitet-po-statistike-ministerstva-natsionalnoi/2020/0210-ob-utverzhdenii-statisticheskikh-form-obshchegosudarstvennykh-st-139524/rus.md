...
| [`an015`](rus/an015.md) | Инструкция по заполнению статистической формы общегосударственного статистического наблюдения «Отчет об итогах сева под урожай» (индекс 4-сх, периодичность один раз в год) |
