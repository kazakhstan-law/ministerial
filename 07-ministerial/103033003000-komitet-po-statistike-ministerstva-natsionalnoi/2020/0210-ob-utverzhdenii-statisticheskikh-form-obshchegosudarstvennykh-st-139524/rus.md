...
| [`an008`](rus/an008.md) | Инструкция по заполнению статистической формы общегосударственного статистического наблюдения «Отчет о деятельности в лесоводстве и лесозаготовках» (индекс 1-лес, периодичность годовая) |
| [`an010`](rus/an010.md) | Майлы дақылдар тұқымдарының қолда бары және оның қозғалысы туралы |
