...
| Часть | Название |
|---|---|
| [`an001`](kaz/an001.md) | «Инновациялық қызмет туралы есеп» (индексі 1-инновация, кезеңділігі жылдық) жалпымемлекеттік статистикалық байқауының статистикалық нысанын толтыру жөніндегі нұсқаулық |
