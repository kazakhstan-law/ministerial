...
4. В настоящей Методике используются следующие определения:
   ...
   4) индекс промышленного производства - агрегированный индекс производства по видам деятельности «Горнодобывающая промышленность и разработка карьеров», «Обрабатывающая промышленность», «Электроснабжение, подача газа, пара и воздушное кондиционирование», «Водоснабжение; канализационная система, контроль над сбором и распределением отходов» согласно Общего классификатора видов экономической деятельности (далее - ОКЭД).
...
13. Учет статистической информации по расчету индекса промышленного производства формируется следующим образом:
    ...
    1) ежемесячно осуществляется сплошной учет объемов произведенной продукции в стоимостном и натуральном выражении по предприятиям с численностью занятых свыше 50 человек. Объемы производства по предприятиям с численностью занятых менее 50 человек, по промышленным подразделениям при непромышленных предприятиях, по индивидуальным предпринимателям и сектору домашних хозяйств определяются расчетным путем;

    2) ежеквартально осуществляется сплошной учет объемов произведенной продукции в стоимостном и натуральном выражении по предприятиям с численностью до 50 человек и по промышленным подразделениям при непромышленных предприятиях;
...
На последующих этапах расчета индексы по элементарному виду деятельности, сформированные на 1 этапе, агрегируются согласно иерархической структуре ОКЭД в индексы по группе видов деятельности, которые, в свою очередь, – в индексы по разделу, секциям B «Горнодобывающая промышленность и разработка карьеров», C «Обрабатывающая промышленность», D «Электроснабжение, подача газа, пара и воздушное кондиционирование» и E «Водоснабжение; канализационная система, контроль над сбором и распределением отходов».

Для учета влияния конкретного вида деятельности (группы, раздела видов деятельности) на общий индекс по секциям B «Горнодобывающая промышленность и разработка карьеров», C «Обрабатывающая промышленность», D «Электроснабжение, подача газа, пара и воздушное кондиционирование» и E «Водоснабжение; канализационная система, контроль над сбором и распределением отходов» ОКЭД осуществляется поэтапное взвешивание на величину валовой добавленной стоимости базисного года по соответствующим группировкам ОКЭД.
...
- валовая добавленная стоимость за базисный год по j-му виду деятельности, млн.тенге.
...
Индекс промышленного производства рассчитывается как среднее арифметическое взвешенное из индексов производства по секциям B «Горнодобывающая промышленность и разработка карьеров», C «Обрабатывающая промышленность», D «Электроснабжение, подача газа, пара и воздушное кондиционирование» и E «Водоснабжение; канализационная система, контроль над сбором и распределением отходов» ОКЭД, по следующим формулам:
...
- индекс производства по секциям B «Горнодобывающая промышленность и разработка карьеров», C «Обрабатывающая промышленность», D «Электроснабжение, подача газа, пара и воздушное кондиционирование» и E «Водоснабжение; канализационная система, контроль над сбором и распределением отходов» за t-период (отчетный месяц, период с начала года) и t-1-период (предыдущий месяц, соответствующие периоды предыдущего года) по сравнению со среднемесячным производством базисного года, в %;

- валовая добавленная стоимость за базисный год по секциям B «Горнодобывающая промышленность и разработка карьеров», C «Обрабатывающая промышленность», D «Электроснабжение, подача газа, пара и воздушное кондиционирование» и E «Водоснабжение; канализационная система, контроль над сбором и распределением отходов», млн.тенге.
...
<tr>
<td rowspan="2"></td>
<td rowspan="2">Цена единицы товара в базисном году, тыс. тенге</td>
<td colspan="2">
Произведено в
базисном году
</td>
<td colspan="3">Произведено в натуральном выражении</td>
<td colspan="3">Произведено в стоимостном выражении (в средних ценах базисного года), тыс.тенге</td>
<td colspan="3">
...
<td>в ст ои-мо стном вы ра жени и, тыс. тен ге</td>
...
<td>за соот-ветств ую-щий ме сяц прошл ого года</td>
<td>за преды-дущий месяц</td>
<td>
за
отчет-ный месяц
...
<tr>
<td>10.12 Переработка и консервирование мяса домашней птицы</td>
<td>Х</td>
<td>Х</td>
<td>26 451 780,3</td>
<td>Х</td>
...
<tr>
<td>Пух и шкурки птиц с перьями, тонн</td>
<td>72,9</td>
<td>249</td>
<td>18 152,1</td>
<td>8</td>
...
## Таблица 2. Условный пример формирования индекса промышленного производства по виду экономической деятельности 10.1 «Переработка и консервирование мяса и производство мясных изделий»
...
за базис-ный год, млн.
тенге
</td>
<td colspan="3">Расчетная величина (исходя из валовой добавленной стоимости базисного года), млн.тенге</td>
<td colspan="3">
Индекс промышленного производства
в % к среднемесячному
уровню базисного года
...
<tr>
<td rowspan="2">10.1 Переработка и консервирование мяса и производство мясных изделий</td>
<td>45 647,2</td>
<td>53 465</td>
<td>52 436</td>
<td>56 342</td>
...
<tr>
<td>10.13Производство продуктов из мяса и мяса домашней птицы</td>
<td>19 852,7</td>
<td>17 530</td>
<td>16 696</td>
<td>18 165</td>
...
<tr>
<td>10.1 Переработка и консервирование мяса и производство мясных изделий</td>
<td>45 647,2</td>
<td>53 453</td>
<td>52 449</td>
<td>56 329</td>
...
<td colspan="4">Расчетная величина (исходя из валовой добавленной стоимости базисного года), млн.тенге</td>
<td colspan="3">
Индекс промышленного
производства
в % к среднемесячному уровню базисного года
</td>
<td colspan="2">Индекс промышленного производства в % к</td>
</tr>
<tr>
...
<tr>
<td>Секция B Горнодобывающая промышленность и разработка карьеров</td>
<td>4249267,9</td>
<td>4606206</td>
<td>4550966</td>
<td>4589209</td>
...
<tr>
<td>Секция С Обрабатывающая промышленность</td>
<td>2469804,1</td>
<td>2603174</td>
<td>2568596</td>
<td>2704435</td>
...
<tr>
<td>Секция D Электроснабжение, подача газа, пара и воздушное кондиционирование</td>
<td>391236,4</td>
<td>381847</td>
<td>404147</td>
<td>381064</td>
...
<tr>
<td>Секция E Водоснабжение; канализационная система, контроль над сбором и распределением отходов</td>
<td>66817,4</td>
<td>73566</td>
<td>57062</td>
<td>69824</td>
