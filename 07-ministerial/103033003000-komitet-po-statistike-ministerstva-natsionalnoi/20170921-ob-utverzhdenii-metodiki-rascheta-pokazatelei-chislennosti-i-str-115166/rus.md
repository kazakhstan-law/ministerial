...
caused_by:
  code: '216803'
  title: О внесении изменений в приказ Председателя Комитета по статистике Министерства национальной экономики Республики Казахстан от 21 сентября 2017 года № 134 «Об утверждении Методики расчета показателей численности и структуры населения»
  link: https://zan.gov.kz/client/#!/doc/216803/rus
source: https://zan.gov.kz/client/#!/doc/115166/rus
---
