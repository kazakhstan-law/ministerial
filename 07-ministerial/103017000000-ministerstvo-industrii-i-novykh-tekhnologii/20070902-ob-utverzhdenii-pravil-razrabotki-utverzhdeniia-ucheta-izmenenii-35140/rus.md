...
caused_by:
  code: '53195'
  title: О внесении изменений и дополнений в приказ Министра индустрии и торговли Республики Казахстан от 2 сентября 2007 года № 256 "Об утверждении Правил разработки, утверждения, учета, изменения, отмены, регистрации, обозначения, издания стандартов организаций"
  link: https://zan.gov.kz/client/#!/doc/53195/rus
source: https://zan.gov.kz/client/#!/doc/35140/rus/23.04.2010
---
...
17. Стандарт организации, подлежащий учету и регистрации, должен быть выполнен на государственном и русском языках.
    ...
    Стандарт организации рассматривается в течение 30 календарных дней. В случае положительного решения проводится регистрация в срок не более 3 рабочих дней. При отрицательном решении направляется на доработку.
    ...
    > *Сноска. Пункт 17 с изменениями, внесенными приказом и.о. Министра индустрии и новых технологий РК от 23.04.2010 № 38 (порядок введения в действие см. п. 4).*
