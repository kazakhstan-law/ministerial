...
caused_by:
  code: '70251'
  title: Қазақстан Республикасының кейбір нормативтік құқықтық актілеріне эмитенттерді және олардың бағалы қағаздарын қор биржасында айналысқа жіберу мәселелері бойынша өзгерістер енгізу туралы
  link: https://zan.gov.kz/client/#!/doc/70251/kaz
